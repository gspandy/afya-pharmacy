            ...
            <#list shipGroups as group>
              ...
              <form method="post" action="#" name="editgroupform${groupIdx}" style="margin: 0;">
                ...
                <tr>
                  ...
                  <td><input type="button" class="btn btn-primary" value="${uiLabelMap.CommonSave}" onclick="javascript:submitForm(document.editgroupform${groupIdx}, 'SV', null);"/></td>
                </tr>
          ...
          <#list cart.items() as cartLine>
            ...
            <tr>
              <form method="post" action="<@ofbizUrl>updatesplit</@ofbizUrl>" name="editgroupform" style="margin: 0;">
                ...
                <td><input type="submit" class="btn btn-primary" value="${uiLabelMap.CommonSubmit}"/></td>
              </form>
            </tr>
          </#list>
        </table>
