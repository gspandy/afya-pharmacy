        ...
        <td>
          <#if (contactListParty.statusId?if_exists == "CLPT_ACCEPTED")>            
            ...
            <div>
              ...
              <input type="submit" value="${uiLabelMap.EcommerceUnsubscribe}" class="btn btn-primary"/>
              </div>
            </form>
          <#elseif (contactListParty.statusId?if_exists == "CLPT_PENDING")>
            ...
            <div>
              ...
              <input type="submit" value="${uiLabelMap.EcommerceVerifySubscription}" class="btn btn-primary"/>
              </div>
            </form>
          <#elseif (contactListParty.statusId?if_exists == "CLPT_REJECTED")>
            ...
            <div>
              ...
              <input type="submit" value="${uiLabelMap.EcommerceSubscribe}" class="btn btn-primary"/>
              </div>
            </form>
          </#if>
        </td>
