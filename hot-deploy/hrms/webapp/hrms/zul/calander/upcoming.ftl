...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <h3>CalendarUpComingEventsView</h3>
  </div>
  <#if days?has_content>
...
<#--              <td>${workEffort.getRelatedOne("WorkEffortType").get("description",locale)}</td>   -->
              <td class="button-col">
              <a href="<@ofbizUrl>EditWorkEffort?workEffortId=${workEffort.workEffortId}${addlParam?if_exists}</@ofbizUrl>">${workEffort.workEffortName?if_exists}</a></td>
            </tr>
