...
<fo:layout-master-set>
 ...
 <fo:block font-size="15pt" text-align="center" font-weight="bold">Issue To Sub Contract</fo:block>
              ...
              <fo:table-column column-width="100pt"/>
                ...
                <fo:table-header>
                    <fo:table-row font-weight="bold">
                        ...
                        <fo:table-cell border-bottom="thin solid grey"><fo:block>Supplier</fo:block></fo:table-cell>
                        <fo:table-cell border-bottom="thin solid grey"><fo:block>Issue/Receive</fo:block></fo:table-cell>
                ...
                <fo:table-body>
                    ...
                    <#list phyInvVarianceList as phyInvVariance>
                        <fo:table-row>
                            ...
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block>${phyInvVariance.partyIdTo?if_exists}</fo:block>
                            </fo:table-cell>
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                    ...
                    <fo:table-row>
                            ...
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block>Total Issue</fo:block>
                            </fo:table-cell>
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block>${totalRemaining?if_exists}</fo:block>
                            </fo:table-cell>
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block></fo:block>
                            </fo:table-cell>
