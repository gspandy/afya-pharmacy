...
<#if mechMap.contactMechTypeId?has_content>
  ...
  <div style="margin-left: 140px;">
    <a href="<@ofbizUrl>${donePage?if_exists}?partyId=${partyId}</@ofbizUrl>" class="btn" style="font-weight: bold;">${uiLabelMap.CommonGoBack}</a>
