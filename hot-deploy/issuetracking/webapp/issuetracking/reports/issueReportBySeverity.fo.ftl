...
<fo:layout-master-set>
 ...
 <fo:block font-size="15pt" text-align="center" font-weight="bold">Report by Issue Severity</fo:block>
        ...
        <fo:table font-size="8pt">
            ...
            <fo:table-header>
                <fo:table-row font-weight="bold" >
                    ...
                    <fo:table-cell border-bottom="thin solid grey"><fo:block>Severity</fo:block></fo:table-cell>
                    ...
                    <fo:table-cell border-bottom="thin solid grey"><fo:block>Updated By</fo:block></fo:table-cell>
                    <fo:table-cell border-bottom="thin solid grey"><fo:block>Updated On</fo:block></fo:table-cell>
                </fo:table-row>
            </fo:table-header>
            <fo:table-body>
                ...
                <#list issueReportList as issueReport>
                    <fo:table-row>
                        ...
                        <fo:table-cell padding="2pt" background-color="${rowColor}">
                            <fo:block>${issueReport.status?default("")}</fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding="2pt" background-color="${rowColor}">
                            <fo:block>${issueReport.severity?default("")}</fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding="2pt" background-color="${rowColor}">
                            <fo:block>${issueReport.category?default("")}</fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding="2pt" background-color="${rowColor}">
                            <fo:block>${issueReport.subCategory?default("")}</fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding="2pt" background-color="${rowColor}">
                        ...
                        <fo:table-cell padding="2pt" background-color="${rowColor}">
                            <fo:block>${Static["com.smebiz.common.PartyUtil"].getFullName(delegator,issueReport.lastUpdatedBy," ")}</fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding="2pt" background-color="${rowColor}">
                            <fo:block>${issueReport.lastUpdatedOn?default("")}</fo:block>
                        </fo:table-cell>
                    </fo:table-row>
