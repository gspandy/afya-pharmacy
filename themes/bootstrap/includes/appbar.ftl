...
<html lang="${docLangAttr}" dir="${langDir}" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>SME Business Mantra: <#if (page.titleProperty)?has_content>${uiLabelMap[page.titleProperty]}<#else>${(page.title)?if_exists}</#if></title>
            ...
            <ul class="nav">
                <#list displayApps as display>
                    ...
                    <#if permission == true>
                        ...
                        <#else>
                                <li<#if selected> class="active"</#if>><a href="${thisURL}${externalKeyParam}" <#if uiLabelMap?exists> title="${uiLabelMap[display.description]}"><b>${uiLabelMap[display.title]}</b><#else> title="${display.description}"><b>${display.title}</b></#if></a></li>
                        </#if>
                    </#if>
                </#list>
                
                <li>
                    <img src="/bootstrap/images/logo.png" height="40px" width="50px" style="height:40px !important"/>
