...
public class OFBizSecurity implements Security {
    ...
    protected static Map<String, Map<String, String>> simpleRoleEntity =null;

    static{
        simpleRoleEntity = new HashMap<String, Map<String, String>>();
        Map<String,String> m1 = new HashMap<String, String>();
        m1.put("name", "OrderRole");
        m1.put("pkey", "orderId");
        simpleRoleEntity.put("ORDERMGR",m1);

        Map<String,String> m2 = new HashMap<String, String>();
        m2.put("name", "FacilityParty");
        m2.put("pkey", "facilityId");
        simpleRoleEntity.put("FACILITY",m2);

        Map<String,String> m3 = new HashMap<String, String>();
        m3.put("name", "MarketingCampaignRole");
        m3.put("pkey", "marketingCampaignId");
        simpleRoleEntity.put("MARKETING",m3);
    }
    ...
    public Iterator<GenericValue> findUserLoginSecurityGroupByUserLoginId(String userLoginId) {
        ...
        try {
            collection = delegator.findByAnd("UserLoginSecurityGroup", UtilMisc.toMap("userLoginId", userLoginId), UtilMisc.toList("groupId ASC"));
