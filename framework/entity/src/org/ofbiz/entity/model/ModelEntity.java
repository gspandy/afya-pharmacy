...
public class ModelEntity extends ModelInfo implements Comparable<ModelEntity>, Serializable {
    ...
    protected List<ModelUniqueKey> uniqueKeys = FastList.newInstance();
    ...
    public ModelEntity(ModelReader reader, Element entityElement, UtilTimer utilTimer, ModelInfo def) {
        ...
        this.populateUniqueKeys(reader, entityElement);
    ...
    protected void populateUniqueKeys(ModelReader reader, Element entityElement) {
    	for (Element uniqueKeyElement : UtilXml.childElementList(entityElement, "unique-constraint")) {
    		ModelUniqueKey uniqueKey = reader.createUniqueKey(this, uniqueKeyElement);
    		if (uniqueKey != null) {
    			uniqueKey.setModelEntity(this);
    ...
    public List<ModelUniqueKey> getUniqueKeysUnmodifiable() {
