...
public class ComponentConfig {
	...
	public ComponentConfig(String globalName,String rootLocation, URL xmlUrl) throws ComponentException {
		this.rootLocation=rootLocation;
		initialize(xmlUrl);
		componentConfigs.put(globalName, this);
		if (Debug.verboseOn())
			Debug.logVerbose("Read component config : [" + xmlUrl + "]", module);
	}
	
	private void initialize(URL xmlUrl) throws ComponentException {
    ...
    public URL getURL(String resourceLoaderName, String location) throws ComponentException {
        ...
        if ("component".equals(resourceLoaderInfo.type) || "file".equals(resourceLoaderInfo.type)) {
            ...
            if (fileUrl == null) {
            	fileUrl = Thread.currentThread().getContextClassLoader().getResource(rootLocation+componentName+"/"+location);
            	if (fileUrl == null)
