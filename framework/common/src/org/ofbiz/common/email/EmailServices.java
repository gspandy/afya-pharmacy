...
public class EmailServices {
    ...
    public static Map<String, Object> sendMail(DispatchContext ctx, Map<String, ? extends Object> context) {
        ...
        try {
           ...
           // System.out.println("\n\n\n\n session.getProperty 1111 " + session.getProperty("mail.smtp.port"));
           ...
           // System.out.println("\n\n\n\n session.getProperty " + session.getProperty("mail.smtp.port"));
            //System.out.println("\n\n\n\n session.getProperties() 1111  " + session.getProperties());
            // message code prefix may be used by calling services to determine the cause of the failure
