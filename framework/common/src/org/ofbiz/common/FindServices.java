...
public class FindServices {
    ...
    public static Map<String, Object> getUserPermissionDetail(DispatchContext dctx, Map<String, ?> context) throws GenericEntityException {
        Map<String, Object> result = new HashMap<String, Object>();
        Delegator delegator = dctx.getDelegator();
        String userLoginId = (String) context.get("userLoginId");
        GenericValue userLoginGv = delegator.findOne("UserLogin", UtilMisc.toMap("userLoginId", userLoginId), false);
        GenericValue companyGv = delegator.findOne("PartyGroup", UtilMisc.toMap("partyId", "Company"), false);
        String logoImageUrl = companyGv.getString("logoImageUrl");
        if (UtilValidate.isNotEmpty(logoImageUrl)) {
            logoImageUrl = "/images/" + logoImageUrl;
        }
        Map<String, Object> userDetail = new HashMap<String, Object>();
        userDetail.put("logoImageUrl", logoImageUrl);
        Security security = dctx.getSecurity();
        userDetail.put("isAdmin", security.hasPermission("HUMANRES_ADMIN", userLoginGv));
        userDetail.put("isManager", security.hasPermission("HUMANRES_MGR", userLoginGv));
