...
<#macro displayButtonBar>
    <div class="button-bar">
        <a href="<@ofbizUrl>EditUtilCacheClear?UTIL_CACHE_NAME=${cacheName?if_exists}</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.WebtoolsClearThisCache}</a>
        <a href="<@ofbizUrl>FindUtilCache</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.WebtoolsBackToCacheMaintenance}</a>
    </div>
</#macro>
<div class="screenlet">
