...
<div id="stats-bins-history" class="screenlet">
    ...
    <div class="button-bar"><a href="<@ofbizUrl>StatsSinceStart</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.WebtoolsStatsMainPageTitle}</a>
    <a href="<@ofbizUrl>StatBinsHistory?statsId=${parameters.statsId}&amp;type=${parameters.type}</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.WebtoolsStatsReloadPage}</a></div>
