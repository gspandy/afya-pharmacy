        ...
        try {
            ...
            try {
                ...
                if (UtilValidate.isEmpty(event.invoke))
                 script = InvokerHelper.createScript(GroovyUtil.getScriptClassFromLocation(event.path, groovyClassLoader), GroovyUtil.getBinding(context));
                else
                    script = InvokerHelper.createScript(GroovyUtil.getScriptClassFromLocation(event.path+File.separatorChar+event.invoke, groovyClassLoader), GroovyUtil.getBinding(context));   
