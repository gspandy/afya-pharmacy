...
public class JasperReportsPdfViewHandler implements ViewHandler {
    ...
    private String name = "Jasper Report PDF View";
    ...
    public void render(String name, String page, String info, String contentType, String encoding, HttpServletRequest request,
        ...
        try {
            Class.forName("org.eclipse.jdt.internal.compiler.env.INameEnvironment");
        ...
        try {
            ...
            if (report == null) {
                synchronized (this) {
                    ...
                    if (report == null) {
                        InputStream is = servletContext.getResourceAsStream(page);
