...
public class ControlServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        // Begin SME Business Basics Specific: Pradyumna -08/11/2008 - Storing the CONTROL_SERVLET Reference in ServletContext to be used in FreemarkerWorker.
        config.getServletContext().setAttribute("CONTROL_SERVLET", this);
        // End SME Business Basics Specific: Pradyumna -08/11/2008 - Storing the CONTROL_SERVLET Reference in ServletContext to be used in FreemarkerWorker.
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("security",getServletContext().getAttribute("security"));
        ...
        // Begin SME Business Mantra Specific: Nafis - 28/02/2011 - As discussed with Shiva Ku. only admin can able to view the webtools.
        if(UtilValidate.isNotEmpty(userLogin) && !("admin".equals(userLogin.getString("partyId"))) && "webtools".equalsIgnoreCase(webappName)){
            session.removeAttribute("userLogin");
            return;
        }
        // End SME Business Mantra Specific: Nafis - 28/02/2011 - As discussed with Shiva Ku. only admin   can able to view the webtools.
