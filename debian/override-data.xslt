...
-->
 ...
 <xsl:template mode="data" match="
  ProductStoreEmailSetting[
   @bccAddress='smesupport@nthdimenzion.com' or
   @fromAddress='smesupport@nthdimenzion.com']|ContactList[
   @verifyEmailFrom='smesupport@nthdimenzion.com'
  ]|ContactMech[
   @infoString='smesupport@nthdimenzion.com'
  ]|WorkflowDataField[
   @initialValue='smesupport@nthdimenzion.com'
  ]|UserLogin[
 ...
 <xsl:template mode="match" match="ProductStoreEmailSetting/@bccAddress|ProductStoreEmailSetting/@fromAddress|ProductStoreEmailSetting/@verifyEmailFrom|ContactMech/@infoString|ContactList/@verifyEmailFrom|WorkflowDataField/@initialValue">
  <xsl:attribute name="{name()}">
   <xsl:choose>
    <xsl:when test=". = 'smesupport@nthdimenzion.com'"><xsl:value-of select="$fromemail"/></xsl:when>
