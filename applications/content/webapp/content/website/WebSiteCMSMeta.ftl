...
<form name="cmsmetaform" action="javascript:void(0);" style="margin: 0;">
    <table>
        ...
        <tr>
            <td colspan="2" align="center"><input id="submit" type="button" onclick="javascript:saveMetaInfo(cmsmetaform);" class="btn btn-primary" value="${uiLabelMap.CommonSave}"/></td>
        </tr>
    </table>
</form>