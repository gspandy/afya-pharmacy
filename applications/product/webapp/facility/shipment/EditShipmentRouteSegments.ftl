...
<div class="screenlet">
        ...
        <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
            <td valign="top">
                <div>
                    ...
                    <br />
                    <a href="javascript:document.updateShipmentRouteSegmentForm${shipmentRouteSegmentData_index}.submit();" class="btn btn-success">${uiLabelMap.CommonUpdate}</a>
                    <br />
                    <a href="javascript:document.duplicateShipmentRouteSegment_${shipmentRouteSegmentData_index}.submit();" class="btn btn-success">${uiLabelMap.CommonDuplicate}</a>
                    <br />
                    <a href="javascript:document.deleteShipmentRouteSegment_${shipmentRouteSegmentData_index}.submit();" class="btn btn-danger">${uiLabelMap.CommonDelete}</a>
                </div>
            </td>
            <td valign="top">
                <div>
            ...
            <td valign="top">
                <div>
                        ...
                        <#if !shipmentRouteSegment.carrierServiceStatusId?has_content || "SHRSCS_NOT_STARTED" == shipmentRouteSegment.carrierServiceStatusId?if_exists>
                            ...
                            <#if shipmentMethodType?exists && shipmentMethodType.shipmentMethodTypeId=="GROUND_HOME">
                                ...
                                <input type="text" size="25" name="" value=""/>
                                  <@htmlTemplate.renderDateTimeField name="homeDeliveryDate" value="(${(shipmentRouteSegment.homeDeliveryDate.toString())!nowTimestampString})" className="" alert="" 
						                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="homeDeliveryDate" dateType="date" shortDateInput=false 
						                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
						                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="updateShipmentRouteSegmentForm${shipmentRouteSegmentData_index}"/>
                    ...
                    <br />
                    <@htmlTemplate.renderDateTimeField name="estimatedStartDate" value="(${shipmentRouteSegment.estimatedStartDate.toString()!nowTimestampString})" className="" alert="" 
	                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="estimatedStartDate" dateType="date" shortDateInput=false 
	                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
	                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="updateShipmentRouteSegmentForm${shipmentRouteSegmentData_index}"/>
               
                    <@htmlTemplate.renderDateTimeField name="estimatedArrivalDate" value="(${shipmentRouteSegment.estimatedArrivalDate.toString()!nowTimestampString})" className="" alert="" 
	                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="estimatedArrivalDate" dateType="date" shortDateInput=false 
	                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
	                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="updateShipmentRouteSegmentForm${shipmentRouteSegmentData_index}"/>
                    <br />
 					<@htmlTemplate.renderDateTimeField name="actualStartDate" value="${value!''}" className="" alert="" 
                		title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="actualStartDate" dateType="date" shortDateInput=false 
                		timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
                		hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="shipmentRouteSegment"/>
                		
                     <@htmlTemplate.renderDateTimeField name="actualArrivalDate" value="${value!''}" className="" alert="" 
                		timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
                		hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="shipmentRouteSegment"/>
    ...
    <#list shipmentPackageRouteSegs as shipmentPackageRouteSeg>
        ...
        <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
            ...
            <td valign="top">
                <div>
                    <a href="javascript:document.updateShipmentPackageRouteSegForm${shipmentRouteSegmentData_index}${shipmentPackageRouteSeg_index}.submit();" class="btn btn-success">${uiLabelMap.CommonUpdate}</a>
                    <a href="javascript:document.deleteRouteSegmentShipmentPackage_${shipmentRouteSegmentData_index}_${shipmentPackageRouteSeg_index}.submit();" class="btn btn-danger">${uiLabelMap.CommonDelete}</a>
                </div>
            </td>
        </tr>
        </form>
        ...
        <tr>
            ...
            <td><a href="javascript:document.createShipmentPackageRouteSegForm${shipmentRouteSegmentData_index}.submit()" class="btn btn-success">${uiLabelMap.CommonAdd}</a></td>
            <td>&nbsp;</td>
            </form>
        </tr>
        -->
            ...
            <tr>
                <td valign="top">
                    <div>
                        ...
                        <br />
                        <a href="javascript:document.createShipmentRouteSegmentForm.submit();" class="btn btn-success">${uiLabelMap.CommonCreate}</a>
                    </div>
                </td>
                <td valign="top">
                    <div>
                ...
                <td valign="top">
                    ...
                    <br />
                    <input type="text" size="25" name="estimatedStartDate" value=""/>
                      <@htmlTemplate.renderDateTimeField name="estimatedStartDate" value="${nowTimestampString!''}" className="" alert="" 
		                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="estimatedStartDate" dateType="date" shortDateInput=false 
		                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
		                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="createShipmentRouteSegmentForm"/>
		 
                      <@htmlTemplate.renderDateTimeField name="estimatedArrivalDate" value="${nowTimestampString!''}" className="" alert="" 
		                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="estimatedArrivalDate" dateType="date" shortDateInput=false 
		                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
		                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="createShipmentRouteSegmentForm"/>
                    
                    <br />
                    <@htmlTemplate.renderDateTimeField name="actualStartDate" value="${nowTimestampString!''}" className="" alert="" 
		                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="actualStartDate" dateType="date" shortDateInput=false 
		                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
		                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="createShipmentRouteSegmentForm"/>
		                
                    <@htmlTemplate.renderDateTimeField name="actualArrivalDate" value="${nowTimestampString!''}" className="" alert="" 
		                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="actualArrivalDate" dateType="date" shortDateInput=false 
		                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
		                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="createShipmentRouteSegmentForm"/>
