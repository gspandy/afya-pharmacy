...
<#if security.hasEntityPermission("FACILITY", "_VIEW", session)>
    ...
    <div class="screenlet">
        ...
        <div class="screenlet-body">
            <#if invoiceIds?has_content>
                ...
                <div>
                    ...
                    <#list invoiceIds as invoiceId>
                      <li>
                        #<a href="/accounting/control/invoiceOverview?invoiceId=${invoiceId}&amp;externalLoginKey=${externalLoginKey}" target="_blank" class="btn-link">${invoiceId}</a>
            ...
            <!-- select order form -->
       <form name="selectOrderForm" method="post" action="<@ofbizUrl>PackOrder?mode=${requestParameters.mode}</@ofbizUrl>">
              ...
              <table cellspacing="0" class="basic-table">
                <tr>
                  ...
                  <td width="15%">
                    <@htmlTemplate.lookupField formName="selectOrderForm" name="orderId" id="selectOrderForm_orderId" fieldFormName="LookupOrderHeader"/>
                    <script language="JavaScript" type="text/javascript">ajaxAutoCompleter('selectOrderForm_orderId,<@ofbizUrl>LookupOrderHeader</@ofbizUrl>,ajaxLookup=Y&amp;searchValueField=selectOrderForm_orderId', true);</script>
                  </td>
                  <td width="5%">
                ...
                <tr>
                  ...
                  <td colspan="2">
                   ...
                   <!-- hiding weigth package only button <a href="javascript:document.selectOrderForm.action='<@ofbizUrl>WeightPackageOnly?mode=${requestParameters.mode}</@ofbizUrl>';document.selectOrderForm.submit();" class="buttontext">${uiLabelMap.ProductWeighPackageOnly}</a>-->
                  </td>
                </tr>
              </table>
            </form> 
            ...
            <form name="selectPicklistBinForm" method="post" action="<@ofbizUrl>PackOrder?mode=${requestParameters.mode}</@ofbizUrl>" style="margin: 0;">
              <input type="hidden" name="facilityId" value="${facilityId?if_exists}" />
              <table cellspacing="0" class="basic-table">
                <tr>
                 ...
                 <!--   <@htmlTemplate.lookupField value="${picklistBinId?if_exists}" formName="selectPicklistBinForm" name="picklistBinId" id="picklistBinId" fieldFormName="LookupPicklistBin"/> -->
                  </td>
                  <!--<td><span class="label">${uiLabelMap.ProductHideGrid}</span>&nbsp;<input type="checkbox" name="hideGrid" value="Y" <#if (hideGrid == "Y")>checked=""</#if> /></td> -->
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <!--  <a href="javascript:document.selectPicklistBinForm.action='<@ofbizUrl>WeightPackageOnly?mode=${requestParameters.mode}</@ofbizUrl>';document.selectPicklistBinForm.submit();" class="buttontext">${uiLabelMap.ProductWeighPackageOnly}</a> -->
                  </td>
                </tr>
              </table>
            </form>
            <form name="clearPackForm" method="post" action="<@ofbizUrl>ClearPackAll?mode=${requestParameters.mode}</@ofbizUrl>">
              <input type="hidden" name="orderId" value="${orderId?if_exists}"/>
              <input type="hidden" name="shipGroupSeqId" value="${shipGroupSeqId?if_exists}"/>
              <input type="hidden" name="facilityId" value="${facilityId?if_exists}"/>
            </form>
            <form name="incPkgSeq" method="post" action="<@ofbizUrl>SetNextPackageSeq?mode=${requestParameters.mode}</@ofbizUrl>">
              <input type="hidden" name="orderId" value="${orderId?if_exists}"/>
              <input type="hidden" name="shipGroupSeqId" value="${shipGroupSeqId?if_exists}"/>
              <input type="hidden" name="facilityId" value="${facilityId?if_exists}"/>
            </form>
            <form name="clearPackLineForm" method="post" action="<@ofbizUrl>ClearPackLine?mode=${requestParameters.mode}</@ofbizUrl>">
    ...
    <div class="screenlet">
        ...
        <div class="screenlet-body">
              ...
              <#if showInput != "N">
                <hr />
                <form name="singlePackForm" method="post" action="<@ofbizUrl>ProcessPackOrder?mode=${requestParameters.mode}</@ofbizUrl>">
                  ...
                  <table cellpadding="2" cellspacing="0" class="basic-table">
                    <tr>
                      ...
                      <td>
                          ...
                          <input type="button" value="${uiLabelMap.ProductNextPackage}" class="buttontext" onclick="javascript:document.incPkgSeq.submit();" />
                      </td>
                    </tr>
                  </table>
                </form>
              ...
              <#if showInput != "N" && hideGrid != "Y" && itemInfos?has_content>
                <br />
                <form name="multiPackForm" method="post" action="<@ofbizUrl>ProcessBulkPackOrder?mode=${requestParameters.mode}</@ofbizUrl>">
                  <input type="hidden" name="facilityId" value="${facilityId?if_exists}" />
                  <input type="hidden" name="orderId" value="${orderId?if_exists}" />
                  <input type="hidden" name="shipGroupSeqId" value="${shipGroupSeqId?if_exists}" />
                    ...
                    <#if (itemInfos?has_content)>
                      ...
                      <#-- <#list itemInfos as orderItem>  -->
                        ...
                        <tr>
                          ...
                          <td>
                              <a href="/catalog/control/EditProduct?productId=${orderProduct.productId?if_exists}${externalKeyParam}&amp;externalLoginKey=${externalLoginKey}" class="btn-link" target="_blank">${(orderProduct.internalName)?if_exists}</a>
                              <#if orderProduct.productId != product.productId>
              ...
              <!-- complete form -->
              <#if showInput != "N">
                <form name="completePackForm" method="post" action="<@ofbizUrl>CompletePack?mode=${requestParameters.mode}</@ofbizUrl>">
                  <input type="hidden" name="orderId" value="${orderId?if_exists}"/>
                  <input type="hidden" name="shipGroupSeqId" value="${shipGroupSeqId?if_exists}"/>
                  <input type="hidden" name="facilityId" value="${facilityId?if_exists}"/>
                ...
                <table class="basic-table" cellspacing='0'>
                  ...
                  <#list packedLines as line>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="/catalog/control/EditProduct?productId=${line.getProductId()?if_exists}${externalKeyParam}&amp;externalLoginKey=${externalLoginKey}" class="btn-link" target="_blank">${product.internalName?if_exists?default("[N/A]")}</a>
                      </td>
