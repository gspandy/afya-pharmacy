    ...
    <div class="screenlet-body">
        <table border="0" cellpadding="2" cellspacing="0" class="basic-table">
          ...
          <tr>
            ...
            <td width="80%"><#if shipment.primaryOrderId?exists><a href="/ordermgr/control/orderview?orderId=${shipment.primaryOrderId}&amp;externalLoginKey=${requestAttributes.externalLoginKey}" class="btn btn-link">${shipment.primaryOrderId}</a></#if></td>
          </tr>
          <tr>
            <td width="20%" align="right" class="label">${uiLabelMap.ProductPrimaryReturnId}</td>
            <td width="80%"><#if shipment.primaryReturnId?exists><a href="/ordermgr/control/returnMain?returnId=${shipment.primaryReturnId}" class="btn btn-link">${shipment.primaryReturnId}</a></#if></td>
          </tr>
          <tr>
          ...
          <tr>
            <td width="20%" align="right" class="label">Truck Number</td>
            <td width="80%">
              <div>${shipment.truckNumber?if_exists}</div>
            </td>
          </tr>
          <tr>
            <td width="20%" align="right" class="label">Trailer Number</td>
            <td width="80%">
              <div>${shipment.trailerNumber?if_exists}</div>
            </td>
          </tr>
          <tr>
            <td width="20%" align="right" class="label">Driver Name</td>
            <td width="80%">
              <div>${shipment.driverNumber?if_exists}</div>
            </td>
          </tr>
          <tr>
            <td width="20%" align="right" class="label">NRC Number</td>
            <td width="80%">
              <div>${shipment.nrcNumber?if_exists}</div>
            </td>
          </tr>
          <tr>
            <td width="20%" align="right" class="label">Note</td>
            <td width="80%">
              <div>${shipment.note?if_exists}</div>
            </td>
          </tr>
        </table>
    </div>
