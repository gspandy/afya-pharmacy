...
<form name="ReceiveInventoryAgainstPurchaseOrder" action="<@ofbizUrl>ReceiveInventoryAgainstPurchaseOrder</@ofbizUrl>">
    ...
    <div>
        ...
        <input type="submit" value="${uiLabelMap.CommonSelect}" class="btn btn-primary"/>
    </div>
</form>
                ...
                <table cellspacing="0" class="basic-table">
                    ...
                    <#if itemsAvailableToReceive>
                        <tr>
                            ...
                            <td align="right">
                                <a class="btn btn-primary" href="javascript:populateQuantities(${rowCount - 1});document.selectAllForm.submit();">${uiLabelMap.ProductReceiveItem}</a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="12" align="right">
                                <a class="btn btn-primary" href="<@ofbizUrl>completePurchaseOrder?orderId=${orderId}&amp;facilityId=${facilityId}&amp;shipmentId=${shipmentId}</@ofbizUrl>">${uiLabelMap.OrderForceCompletePurchaseOrder}</a>
                            </td>
                        </tr>
                    </#if>
                </table>
