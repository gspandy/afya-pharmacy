...
<#if security.hasEntityPermission("FACILITY", "_VIEW", session)>
  ...
  <div class="screenlet">
    ...
    <#if shipmentId?has_content>
      <div>
        <span class="label">${uiLabelMap.ProductShipmentId}</span><a href="<@ofbizUrl>/ViewShipment?shipmentId=${shipmentId}</@ofbizUrl>" class="btn-link">${shipmentId}</a>
      </div>
   ...
   <form name="selectOrderForm" method="post" action="<@ofbizUrl>VerifyPick?mode=${requestParameters.mode}</@ofbizUrl>">
        ...
        <table cellspacing="0" class="basic-table">
          ...
          <tr>
            <td colspan="2">&nbsp;</td>
            <td colspan="2">
              <input type="submit" value="${uiLabelMap.ProductVerify}&nbsp;${uiLabelMap.OrderOrder}" class="buttontext"/>
            </td>
          </tr>
        </table>
      </form> 
      ...
      <form name="selectPicklistBinForm" method="post" action="<@ofbizUrl>VerifyPick?mode=${requestParameters.mode}</@ofbizUrl>" style="margin: 0;">
        <input type="hidden" name="facilityId" value="${facility.facilityId?if_exists}"/>
        <table cellspacing="0" class="basic-table">
        <!--<tr>
      ...
      <form name="clearPickForm" method="post" action="<@ofbizUrl>cancelAllRows?mode=${requestParameters.mode}</@ofbizUrl>">
  ...
  <#if showInput != "N" && orderHeader?exists && orderHeader?has_content>
    <div class="screenlet">
      ...
      <div class="screenlet-body">
        ...
        <hr />
        <form name="singlePickForm" method="post" action="<@ofbizUrl>processVerifyPick?mode=${requestParameters.mode}</@ofbizUrl>">
          <input type="hidden" name="orderId" value="${orderId?if_exists}"/>
          <input type="hidden" name="shipGroupSeqId" value="${shipGroupSeqId?if_exists}"/>
          <input type="hidden" name="facilityId" value="${facility.facilityId?if_exists}"/>
        ...
        <form name="multiPickForm" method="post" action="<@ofbizUrl>processBulkVerifyPick?mode=${requestParameters.mode}</@ofbizUrl>">
          <input type="hidden" name="facilityId" value="${facility.facilityId?if_exists}"/>
    ...
    <form name="completePickForm" method="post" action="<@ofbizUrl>completeVerifiedPick?mode=${requestParameters.mode}</@ofbizUrl>">
      <input type="hidden" name="orderId" value="${orderId?if_exists}"/>
      <input type="hidden" name="shipGroupSeqId" value="${shipGroupSeqId?if_exists}"/>
      <input type="hidden" name="facilityId" value="${facility.facilityId?if_exists}"/>
      <input type="hidden" name="userLoginId" value="${userLoginId?if_exists}"/>
