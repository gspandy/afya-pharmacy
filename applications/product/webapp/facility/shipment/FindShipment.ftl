...
<#--  <a href="/facility/control/Route" class="buttontext" >Routes</a>  -->
              ...
              <tr>
                ...
                <td>
                  <table cellspacing="0" class="basic-table">
                    <tr>
                      <td>
                          <@htmlTemplate.renderDateTimeField name="minDate" value="" className="" alert="" 
			                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="minDate" dateType="date" shortDateInput=false 
			                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
			                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="lookupShipmentForm"/>
                    ...
                    <tr>
                      <td>
                          <@htmlTemplate.renderDateTimeField name="maxDate" value="" className="" alert="" 
			                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="maxDate" dateType="date" shortDateInput=false 
			                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
			                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="lookupShipmentForm"/>
                ...
                <tr>
                    <td width="5%">&nbsp;&nbsp;</td>
                    <td align="right" >&nbsp;</td>
                    <td> <a href="javascript:lookupShipments();"  class="btn btn-primary">${uiLabelMap.CommonFind}</a></td>
                  </tr>
              </tr>
            </table>
        </form>
...
<div id="findOrders" class="screenlet">
    ...
    <div class="screenlet-body">
        ...
        <tr class="header-row">
          ...
          <td width="20%">${uiLabelMap.ProductDestFacility}</td>
          <td width="10%">${uiLabelMap.ProductShipDate}</td>
          <td width="10%">${uiLabelMap.CommonNote}</td>
          <td width="5%">${uiLabelMap.FormFieldTitle_actionEnumId}</td>
        </tr>
