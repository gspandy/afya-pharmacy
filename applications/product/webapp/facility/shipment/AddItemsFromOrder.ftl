...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        <form name="additemsfromorder" action="<@ofbizUrl>AddItemsFromOrder</@ofbizUrl>">
            ...
            <input type="hidden" name="quantityValue" value="${quantity?if_exists}"/>
            <div>
                ...
                <input type="submit" value="${uiLabelMap.CommonSelect}" class="buttontext"/>
            </div>
        </form>
    </div>
</div>
<div class="screenlet">
    ...
    <#if orderItemDatas?exists>
        ...
        <div align="right"><input type="submit" class="btn btn-success" value="${uiLabelMap.ProductIssueAll}"/></div>
