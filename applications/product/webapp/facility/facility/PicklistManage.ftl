                ...
                <#list picklistInfo.picklistBinInfoList?if_exists as picklistBinInfo>
                    ...
                    <#if (!isBinComplete)>
                        <div style="margin-left: 15px;">
                            ...
                            <#if !picklistBinInfo.picklistItemInfoList?has_content><a href="<@ofbizUrl>deletePicklistBin?picklistBinId=${picklistBinInfo.picklistBin.picklistBinId}&amp;facilityId=${facilityId?if_exists}</@ofbizUrl>" class="btn btn-danger">${uiLabelMap.CommonDelete}</a></#if>
                        </div>
                                        ...
                                        <#if !picklistItemInfo.itemIssuanceList?has_content>
                                            <td>
                                                <form name="deletePicklistItem_${picklist.picklistId}_${picklistItem.orderId}_${picklistItemInfo_index}" method="post" action="<@ofbizUrl>deletePicklistItem</@ofbizUrl>">
                                                    ...
                                                    <a href='javascript:document.deletePicklistItem_${picklist.picklistId}_${picklistItem.orderId}_${picklistItemInfo_index}.submit()' class='btn btn-danger'>&nbsp;${uiLabelMap.CommonDelete}&nbsp;</a>
                                                </form>
                                            </td>
                                        </#if>
                                        <td>
