...
<#else>
      ...
      <table width="50%" class="basic-table" cellspacing="0">
        <tr>
          ...
          <td>
            ...
            </select>&nbsp;<a href="javascript:document.createcontactmechform.submit()" class="btn btn-success">${uiLabelMap.CommonCreate}</a>
          </td>
        </tr>
      </table>
    </form>
              ...
              <#list mechMap.facilityContactMechPurposes as facilityContactMechPurpose>
                ...
                <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                  <td>
                      ...
                      <a href="javascript:$('#deleteFacilityContactMechPurpose_${facilityContactMechPurpose_index}').submit();" class="btn btn-mini btn-danger">${uiLabelMap.CommonDelete}</a>
                  </td>
                </tr>
  ...
  <#elseif "TELECOM_NUMBER" = mechMap.contactMechTypeId?if_exists>
    <tr>
      ...
      <td>
        <input type="text" class="required" size="4" maxlength="10" name="countryCode" value="${(mechMap.telecomNumber.countryCode)?default(request.getParameter('countryCode')?if_exists)}" />
        -&nbsp;<input type="text" class="required" size="4" maxlength="10" name="areaCode" value="${(mechMap.telecomNumber.areaCode)?default(request.getParameter('areaCode')?if_exists)}" />
        -&nbsp;<input type="text" class="required" size="15" maxlength="15" name="contactNumber" value="${(mechMap.telecomNumber.contactNumber)?default(request.getParameter('contactNumber')?if_exists)}" />
