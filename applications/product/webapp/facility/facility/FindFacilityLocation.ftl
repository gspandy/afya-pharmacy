...
-->
    ...
    <#--  <div class="button-bar">
      <a href="<@ofbizUrl>EditFacilityLocation?facilityId=${facilityId?if_exists}</@ofbizUrl>" class="btn btn-mini">${uiLabelMap.ProductNewFacilityLocation}</a>
    </div> -->
    ...
    <form action="<@ofbizUrl>FindFacilityLocation</@ofbizUrl>" method="get" name="findFacilityLocation">
        ...
        <tr>
            ...
            <td>
                <@htmlTemplate.lookupField formName="findFacilityLocation" name="locationSeqId" id="locationSeqId" fieldFormName="LookupFacilityLocation"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td><input type="submit" name="look_up" value="${uiLabelMap.CommonFind}" class="btn btn-primary"/></td>
        </tr>
        </table>
    </form>
    ...
    <#if foundLocations?exists>
        ...
        <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
            ...
            <td>${(location.locationSeqId)?if_exists}</td>
