...
<#else>
  ...
  <tr>
    ...
    <td>
      <select name="facilityTypeId" class="required">
  ...
  <tr>
    ...
    <td><input type="text" name="facilityName" value="${facility.facilityName?if_exists}" class="required" size="30" maxlength="60" /><span class="tooltip">${uiLabelMap.CommonRequired}</span><font color="red">*</font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="label">Facility Description</td>
    <td ><input type="text" name="description" value="${facility.description?if_exists}" size="60" maxlength="250" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <#if facilityId?has_content>
      <td><input type="submit" name="Update" value="${uiLabelMap.CommonUpdate}" class="btn btn-success" /></td>
    <#else>
      <td><input type="submit" name="Update" value="${uiLabelMap.CommonSave}" class="btn btn-success" /></td>
    </#if>
  </tr>
</table>
</form>
<script language="JavaScript" type="text/javascript">
 var form = document.EditFacilityForm;
