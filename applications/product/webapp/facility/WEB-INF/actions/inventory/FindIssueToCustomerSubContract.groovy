...
internalName = null;
if(UtilValidate.isNotEmpty(parameters.internalName) )
	internalName = parameters.internalName;

locationSeqId = null;
if(UtilValidate.isNotEmpty(parameters.locationSeqId) )
...
conditions.add(EntityCondition.makeCondition("inventoryItemTypeId", EntityOperator.EQUALS, "NON_SERIAL_INV_ITEM"));
if (productId) {
...
if (conditions.size() > 0) {
	...
	physicalInventory = delegator.findList("ProductInventoryItem", ecl, null, null, null, false);
