...
EntityCondition condition = null;
	...
	andExprs.add(EntityCondition.makeCondition("estimatedArrivalDate", EntityOperator.GREATER_THAN_EQUAL_TO,
		UtilDateTime.getDayStart(filterDate)));
		andExprs.add(EntityCondition.makeCondition("estimatedArrivalDate", EntityOperator.LESS_THAN_EQUAL_TO,
	...
	condition1 = [EntityCondition.makeCondition("statusId", EntityOperator.EQUALS, "PURCH_SHIP_CREATED"),
             EntityCondition.makeCondition("statusId", EntityOperator.EQUALS, "PURCH_SHIP_RECEIVED")];
