...
if (shipment) {
    ...
    if (shipmentItems) {
        shipmentItems.each { shipmentItem ->
            ...
            productList.add(shipmentItem.getRelatedOne("Product"));
        ...
        context.productList=new ArrayList(productList);
    }
    ...
    context.facility=shipment.originFacilityId;
}
