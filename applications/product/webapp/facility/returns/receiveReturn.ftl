...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <h3>${uiLabelMap.ProductReceiveReturn} ${uiLabelMap.CommonInto} <#if facility?has_content>"${facility.facilityName?default("Not Defined")}"</#if> [${uiLabelMap.CommonId}:${facilityId?if_exists}]</h3>
    </div>
    <div class="screenlet-body">
     <#--   <a href="<@ofbizUrl>EditFacility</@ofbizUrl>" class="buttontext">${uiLabelMap.ProductNewFacility}</a> -->
        <#-- Receiving Results -->
        <#if receivedItems?has_content>
          <h3>${uiLabelMap.ProductReceiptForReturn}# <a href="/ordermgr/control/returnMain?returnId=${returnHeader.returnId}${externalKeyParam?if_exists}" class="btn-link">${returnHeader.returnId}</a></h3>
            ...
            <table cellspacing="0" class="basic-table">
              ...
              <#else>
                <tr>
                  <td>
                    <h3>
                      ${uiLabelMap.ProductReceiveReturn} <a href="/ordermgr/control/returnMain?returnId=${returnHeader.returnId}${externalKeyParam?if_exists}" class="btn-link">#${returnHeader.returnId}</a>
                      <#if parameters.shipmentId?has_content>${uiLabelMap.ProductShipmentId} <a href="<@ofbizUrl>ViewShipment?shipmentId=${parameters.shipmentId}</@ofbizUrl>" class="btn-link">${parameters.shipmentId}</a></#if>
                    </h3>
                  </td>
                  <td align="right">
                      ...
                      <table cellspacing="0" class="basic-table">
                        <tr>
                          ...
                          <#if orderItem.productId?exists>
                            ...
                            <td width="45%">
                              <div>
                                ${returnItem.returnItemSeqId}:&nbsp;<a href="/catalog/control/EditProduct?productId=${product.productId}${externalKeyParam?if_exists}&amp;externalLoginKey=${externalLoginKey}" target="catalog" class="btn-link">${product.productId}&nbsp;-&nbsp;${product.internalName?if_exists}</a> : ${product.description?if_exists}
                          ...
                          <td align="right" width="45%">
                            ...
                            <#else>
                                <@htmlTemplate.lookupField formName="selectAllForm" name="locationSeqId_o_${rowCount}" id="locationSeqId_o_${rowCount}" fieldFormName="LookupFacilityLocation?facilityId=${parameters.facilityId}"/>
                            </#if>
                          </td>

                          <td align="right" nowrap="nowrap" class="label">${uiLabelMap.ProductQtyReceived}</td>
                          <td align="right">
                            <input type="text" id="quantityReceived" name="quantityAccepted_o_${rowCount}" size="6" value="${defaultQuantity?string.number}" />
                          </td>
                        </tr>
                        <tr>
                           <td width='10%'>
