...
<#if searchFeatures?has_content>
    <table cellspacing="0" class="basic-table">
        ...
        <tr>
            <td><input type="submit" value="${uiLabelMap.CommonSearch}" class="btn btn-primary" /></td>
        </form>
        <form method="post" action="<@ofbizUrl>LookupProduct</@ofbizUrl>" name="">
            <td><input type="submit" value="${uiLabelMap.CommonBack}" class="btn btn-primary" /></td>
        </form>
    </tr>
    </table>
</#if>
...
<#if productFeatureIds?exists>
    <table cellspacing="0" class="basic-table">
        ...
        <input type="submit" value="${uiLabelMap.ProductQuickAddVariants}" class="btn btn-primary" />
        </form>
    </table>
</#if>
