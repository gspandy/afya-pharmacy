...
<div class="screenlet">
    ...
    <div class="screenlet-body">
      <a href="/content/control/EditWebSite?productStoreId=${productStoreId}&amp;externalLoginKey=${requestAttributes.externalLoginKey}" class="btn-link">${uiLabelMap.ProductCreateNewProductStoreWebSite}</a>
            ...
            <#if storeWebSites?has_content>
              ...
              <#list storeWebSites as webSite>
                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                  <td><a href="/content/control/EditWebSite?webSiteId=${webSite.webSiteId}&amp;externalLoginKey=${requestAttributes.externalLoginKey}" class="btn-link">${webSite.siteName?if_exists} [${webSite.webSiteId}]</a></td>
                  <td>${webSite.httpHost?default('&nbsp;')}</td>
                  <td>${webSite.httpPort?default('&nbsp;')}</td>
                  <td align="center">
                    <a href="javascript:document.storeUpdateWebSite_${webSite_index}.submit();" class="btn btn-danger">${uiLabelMap.CommonDelete}</a>
