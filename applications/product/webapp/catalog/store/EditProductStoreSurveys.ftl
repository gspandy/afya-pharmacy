        ...
        <table cellspacing="0" class="basic-table">
            ...
            <#list productStoreSurveys as storeSurvey>
              ...
              <tr valign="middle"<#if alt_row>class="alternate-row"</#if>>
                ...
                <td><a href="/content/control/EditSurvey?surveyId=${storeSurvey.surveyId}" class="btn-link">${survey.description?default("[" + survey.surveyId + "]")}</a></td>
                ...
                <td>
                  <form name="deleteProductStoreSurveyAppl_${storeSurvey_index}" method="post" action="<@ofbizUrl>deleteProductStoreSurveyAppl</@ofbizUrl>">
                    ...
                    <a href="javascript:document.deleteProductStoreSurveyAppl_${storeSurvey_index}.submit()" class="btn btn-danger">${uiLabelMap.CommonDelete}</a>
                  </form>
                </td>
              </tr>
    ...
    <div class="screenlet-body">
        <form name="addSurvey" action="<@ofbizUrl>createProductStoreSurveyAppl</@ofbizUrl>" method="post">
            ...
            <table cellspacing="0" class="basic-table">
              ...
              <tr>
                <td>&nbsp;</td>
                <td><input type="submit" class="btn btn-success" value="${uiLabelMap.CommonAdd}" /></td>
              </tr>
            </table>
        </form>
    </div>
