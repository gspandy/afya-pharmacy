...
<#if productCategoryId?exists && productCategory?exists>
    <div class="screenlet">
        ...
        <div class="screenlet-body">
            ...
            <td><a href="/partymgr/control/viewprofile?party_id=${(productCategoryRole.partyId)?if_exists}" target="_blank" class="btn-link">${(productCategoryRole.partyId)?if_exists}</a></td>
