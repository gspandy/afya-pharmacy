        ...
        <div class="screenlet-body">
            ...
            <table cellspacing="0" class="basic-table">
                ...
                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                    ...
                    <td align="center">
                        <a href="javascript:document.removeProductFeatureCatGrpApplForm_${productFeatureCatGrpAppl_index}.submit()" class="btn btn-danger">${uiLabelMap.CommonDelete}</a>
        ...
        <div class="screenlet-body">
            ...
            <table cellspacing="0" class="basic-table">
                ...
                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                    ...
                    <td align="center">
                    <a href="javascript:document.removeProductFeatureCategoryApplForm_${productFeatureCategoryAppl_index}.submit()" class="btn btn-danger">${uiLabelMap.CommonDelete}</a>
