...
jQuery.validator.addMethod("nospaces", function(value, element) {
	$(element).val($(element).val().trim(/(\s)/g,''));
	return this.optional(element) || /^\S+$/i.test($(element).val());
}, "Category Id should not contain spaces");
</script>
...
<#if ! productCategory?has_content>
    <#if productCategoryId?has_content>
        ...
        <div class="screenlet-body">
            <form action="<@ofbizUrl>createProductCategory</@ofbizUrl>" method="post" style="margin: 0;" name="productCategoryForm" id="productCategoryForm">
                <table cellspacing="0" class="basic-table">
                    <tr>
                        <td align="right" class="label">${uiLabelMap.ProductProductCategoryId}</td>
                        <td>&nbsp;</td>
                        <td>
                            <input type="text" name="productCategoryId" class="nospaces" size="20" maxlength="40" value="${productCategoryId}"/>
                        </td>
                    </tr>
    <#else>
        <div class="screenlet-title-bar">
            ...
            <form action="<@ofbizUrl>createProductCategory</@ofbizUrl>" method="post" style="margin: 0;" name="productCategoryForm" id="productCategoryForm">
                <table cellspacing="0" class="basic-table">
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <input type="text" name="productCategoryId" class="nospaces" size="20" maxlength="40" value=""/>
                        </td>
                    </tr>
    </#if>
<#else>
    ...
    <div class="screenlet-body">
        <form action="<@ofbizUrl>updateProductCategory</@ofbizUrl>" method="post" style="margin: 0;" name="productCategoryForm" id="productCategoryForm">
            ...
            <table cellspacing="0" class="basic-table">
                ...
                <#if productCategoryId?has_content>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                        <td><input type="submit" class="btn btn-success" name="Update" value="${uiLabelMap.CommonUpdate}"/></td>
                    </tr>
                <#else>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                        <td><input type="submit" class="btn btn-success" name="Create" value="${uiLabelMap.CommonCreate}"/></td>
                    </tr>
                </#if>
            </table>
             <script>
            ...
            <form method="post" enctype="multipart/form-data" action="<@ofbizUrl>UploadCategoryImage?productCategoryId=${productCategoryId?if_exists}&amp;upload_file_type=category</@ofbizUrl>" name="imageUploadForm">
                <table cellspacing="0" class="basic-table">
                    <tr><td>
                        ...
                        <input type="submit" class="btn btn-primary" value="${uiLabelMap.ProductUploadImage}"/>
                    </td></tr>
                </table>
            </form>
        </div>
            ...
            <form action="<@ofbizUrl>DuplicateProductCategory</@ofbizUrl>" method="post" style="margin: 0;">
                <table cellspacing="0" class="basic-table">
                    <tr><td>
                        ...
                        <div>
                            <input type="text" size="20" maxlength="20" name="productCategoryId"/>&nbsp;<input type="submit" class="btn btn-primary" value="${uiLabelMap.CommonGo}"/>
                        </div>
                        <div>
