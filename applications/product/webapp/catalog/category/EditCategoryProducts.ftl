...
-->
<#if activeOnly>
    <a href="<@ofbizUrl>EditCategoryProducts?productCategoryId=${productCategoryId?if_exists}&amp;activeOnly=false</@ofbizUrl>" class="btn-link">${uiLabelMap.ProductActiveAndInactive}</a>
<#else>
    <a href="<@ofbizUrl>EditCategoryProducts?productCategoryId=${productCategoryId?if_exists}&amp;activeOnly=true</@ofbizUrl>" class="btn-link">${uiLabelMap.ProductActiveOnly}</a>
</#if>
<div class="screenlet">
                ...
                <#if productCategoryMember.thruDate?exists && nowTimestamp.after(productCategoryMember.getTimestamp("thruDate"))><#assign hasExpired = true></#if>
                  <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                    <td>
                      ...
                      <a href="<@ofbizUrl>EditProduct?productId=${(productCategoryMember.productId)?if_exists}</@ofbizUrl>" class="btn-link"><#if product?exists>${(product.internalName)?if_exists}</#if> [${(productCategoryMember.productId)?if_exists}]</a>
                    </td>
                    ...
                    <td align="center">
                      <a href="javascript:document.deleteProductFromCategory_o_${rowCount}.submit()" class="btn btn-mini btn-danger">${uiLabelMap.CommonDelete}</a>
                    </td>
                  </tr>
            ...
            <tr><td>
                <form method="post" action="<@ofbizUrl>copyCategoryProductMembers</@ofbizUrl>" style="margin: 0;" name="copyCategoryProductMembersForm">
                    ...
                    <div>
                        ...
                        <input type="submit" value="${uiLabelMap.CommonCopy}" class="buttontext"/>
                    </div>
                </form>
            </td></tr>
        </table>
            ...
            <tr><td>
                <form method="post" action="<@ofbizUrl>expireAllCategoryProductMembers</@ofbizUrl>" style="margin: 0;" name="expireAllCategoryProductMembersForm">
                    ...
                    <div>
                        ...
                        &nbsp;&nbsp;<input type="submit" value="${uiLabelMap.CommonExpireAll}" class="btn btn-danger"/>
                    </div>
                </form>
            </td></tr>
        </table>
            ...
            <tr><td>
                <form method="post" action="<@ofbizUrl>removeExpiredCategoryProductMembers</@ofbizUrl>" style="margin: 0;" name="removeExpiredCategoryProductMembersForm">
                    ...
                    <div>
                        ...
                        &nbsp;&nbsp;<input type="submit" value="${uiLabelMap.CommonRemoveExpired}" class="btn btn-danger"/>
                    </div>
                </form>
            </td></tr>
        </table>
