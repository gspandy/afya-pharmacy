...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        ...
        <tr>
            <td colspan="2">&nbsp;</td>
            <td><input type="submit" class="btn btn-success" <#if isCreate>value="${uiLabelMap.CommonCreate}"<#else>value="${uiLabelMap.CommonUpdate}"</#if> /></td>
        </tr>
        </table>
        </form>
    </div>
...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        <table cellspacing="0" class="basic-table">
            ...
            <td><b>${uiLabelMap.FormFieldTitle_actionEnumId}</b></td>
            <td><b>&nbsp;</b></td>
            </tr>
            <#assign rowClass = "2">
            ...
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                <td><a href="<@ofbizUrl>EditProduct?productId=${(assocFromProduct.productIdTo)?if_exists}</@ofbizUrl>" class="btn-link">${(assocFromProduct.productIdTo)?if_exists}</a></td>
                <td><#if listToProduct?exists><a href="<@ofbizUrl>EditProduct?productId=${(assocFromProduct.productIdTo)?if_exists}</@ofbizUrl>" class="btn-link">${(listToProduct.internalName)?if_exists}</a></#if>&nbsp;</td>
...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        <table cellspacing="0" class="basic-table">
            ...
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                <td><a href="<@ofbizUrl>EditProduct?productId=${(assocToProduct.productId)?if_exists}</@ofbizUrl>" class="btn-link">${(assocToProduct.productId)?if_exists}</a></td>
                <td><#if listToProduct?exists><a href="<@ofbizUrl>EditProduct?productId=${(assocToProduct.productId)?if_exists}</@ofbizUrl>" class="btn-link">${(listToProduct.internalName)?if_exists}</a></#if></td>
