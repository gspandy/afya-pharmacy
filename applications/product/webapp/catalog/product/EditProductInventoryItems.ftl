               ...
               <#if showEmpty || (inventoryItem.inventoryItemTypeId?if_exists == "SERIALIZED_INV_ITEM" && inventoryItem.statusId?if_exists != "INV_DELIVERED")
                    ...
                    <#if curInventoryItemType?exists>
                        <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                            <td><a href="/facility/control/EditInventoryItem?inventoryItemId=${(inventoryItem.inventoryItemId)?if_exists}${externalKeyParam}" class="btn-link">${(inventoryItem.inventoryItemId)?if_exists}</a></td>
                            ...
                            <td align="center">
                                ...
                                <#elseif inventoryItemDetailFirst?exists && inventoryItemDetailFirst.orderId?exists>
                                   <a href="/ordermgr/control/orderview?orderId=${inventoryItemDetailFirst.orderId}${externalKeyParam}" class="linktext">${inventoryItemDetailFirst.orderId}</a>
                                </#if>
                            </td>
