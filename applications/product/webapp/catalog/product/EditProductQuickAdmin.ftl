    ...
    <div class="screenlet-body">
        ...
        <#list productAssocs as productAssoc>
            ...
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                ...
                <a class="btn-link" href="<@ofbizUrl>EditProduct?productId=${assocProduct.productId}</@ofbizUrl>">${assocProduct.productId?if_exists}</a></td>
                <td width="100%"><a class="btn-link" href="<@ofbizUrl>EditProduct?productId=${assocProduct.productId}</@ofbizUrl>">${assocProduct.internalName?if_exists}</a></td>
                <td colspan="2">
