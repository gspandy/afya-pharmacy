...
<#if featureTypes?has_content && (featureTypes.size() > 0)>
            ...
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                ...
                <td>
                    ...
                    <#list existingVariantProductIds as existingVariantProductId>
                        <a href="<@ofbizUrl>EditProduct?productId=${existingVariantProductId}</@ofbizUrl>" class="btn-link">${existingVariantProductId}</a>
                    </#list>
                    </div>
                </td>
                <td align="center">
        ...
        <tr>
            ...
            <td colspan="${columns}" align="center">
                ...
                <input type="submit" class="btn btn-success" value="${uiLabelMap.CommonCreate}"/>
            </td>
        </tr>
        </table>
    </form>
    ...
    <table cellspacing="0" class="basic-table">
        ...
        <tr>
            <td>
                ...
                <input type="submit" class="btn btn-success" value="${uiLabelMap.ProductVariantAdd}"/>
            </td>
        </tr>
    </table>
</form>