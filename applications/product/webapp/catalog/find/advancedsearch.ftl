      ...
      <table cellspacing="0" class="basic-table">
            ...
            <tr>
              ...
              <td valign="middle">
                <div>
                  ...
                  <input type="radio" name="SEARCH_SUB_CATEGORIES" style="margin-bottom: 6px;" value="Y" checked="checked" />${uiLabelMap.CommonYes}
                  <input type="radio" name="SEARCH_SUB_CATEGORIES" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonNo}
                </div>
              </td>
            </tr>
        <#else>
            ...
            <tr>
              ...
              <td valign="middle">
                <div>
                  ...
                  <input type="radio" name="SEARCH_SUB_CATEGORIES" style="margin-bottom: 6px;" value="Y" checked="checked"/>${uiLabelMap.CommonYes}
                  <input type="radio" name="SEARCH_SUB_CATEGORIES" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonNo}
                  <input type="radio" name="SEARCH_CATEGORY_EXC" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_CATEGORY_EXC" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_CATEGORY_EXC" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
                </div>
              </td>
            </tr>
        </#if>
        ...
        <tr>
          ...
          <td valign="middle">
            <div>
              ...
              <input type="radio" name="SEARCH_OPERATOR" style="margin-bottom: 6px;" value="OR" <#if searchOperator == "OR">checked="checked"</#if>/>${uiLabelMap.CommonAny}
              <input type="radio" name="SEARCH_OPERATOR" style="margin-bottom: 6px;" value="AND" <#if searchOperator == "AND">checked="checked"</#if>/>${uiLabelMap.CommonAll}
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td valign="middle">
            <div>
              <input type="text" name="SEARCH_PROD_FEAT_CAT1" size="15" value="${requestParameters.SEARCH_PROD_FEAT_CAT1?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC1" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC1" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC1" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
            <div>
              <input type="text" name="SEARCH_PROD_FEAT_CAT2" size="15" value="${requestParameters.SEARCH_PROD_FEAT_CAT2?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC2" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC2" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC2" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
            <div>
              <input type="text" name="SEARCH_PROD_FEAT_CAT3" size="15" value="${requestParameters.SEARCH_PROD_FEAT_CAT3?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC3" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC3" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_CAT_EXC3" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td valign="middle">
            <div>
              <input type="text" name="SEARCH_PROD_FEAT_GRP1" size="15" value="${requestParameters.SEARCH_PROD_FEAT_GRP1?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC1" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC1" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC1" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
            <div>
              <input type="text" name="SEARCH_PROD_FEAT_GRP2" size="15" value="${requestParameters.SEARCH_PROD_FEAT_GRP2?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC2" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC2" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC2" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
            <div>
              <input type="text" name="SEARCH_PROD_FEAT_GRP3" size="15" value="${requestParameters.SEARCH_PROD_FEAT_GRP3?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC3" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC3" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_PROD_FEAT_GRP_EXC3" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
          </td>
        </tr>
          ...
          <td valign="middle">
            <div>
              <input type="text" name="SEARCH_FEAT1" size="15" value="${requestParameters.SEARCH_FEAT1?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_FEAT_EXC1" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_FEAT_EXC1" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_FEAT_EXC1" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
            <div>
              <input type="text" name="SEARCH_FEAT2" size="15" value="${requestParameters.SEARCH_FEAT2?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_FEAT_EXC2" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_FEAT_EXC2" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_FEAT_EXC2" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
            <div>
              <input type="text" name="SEARCH_FEAT3" size="15" value="${requestParameters.SEARCH_FEAT3?if_exists}"/>&nbsp;
                  <input type="radio" name="SEARCH_FEAT_EXC3" style="margin-bottom: 6px;" value="" checked="checked"/>${uiLabelMap.CommonInclude}
                  <input type="radio" name="SEARCH_FEAT_EXC3" style="margin-bottom: 6px;" value="Y"/>${uiLabelMap.CommonExclude}
                  <input type="radio" name="SEARCH_FEAT_EXC3" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonAlwaysInclude}
            </div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td valign="middle">
            <div>
              ...
              <input type="radio" name="sortAscending" style="margin-bottom: 6px;" value="Y" checked="checked" />${uiLabelMap.ProductLowToHigh}
              <input type="radio" name="sortAscending" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.ProductHighToLow}
            </div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <input type="radio" name="SEARCH_GOOD_IDENTIFICATION_INCL" style="margin-bottom: 6px;" value="Y" checked="checked"/>${uiLabelMap.CommonInclude}
            <input type="radio" name="SEARCH_GOOD_IDENTIFICATION_INCL" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonExclude}
          </td>
        </tr>
        <#if searchConstraintStrings?has_content>
          <tr>
            ...
            <td valign="top">
                ...
                <div>
                  <input type="radio" name="clearSearch" style="margin-bottom: 6px;" value="Y" checked="checked"/>${uiLabelMap.ProductNewSearch}
                  <input type="radio" name="clearSearch" style="margin-bottom: 6px;" value="N"/>${uiLabelMap.CommonRefineSearch}
                </div>
            </td>
          </tr>
        </#if>
        <tr>
          <td align="center" colspan="2">
            <hr />
            <a href="javascript:document.advtokeywordsearchform.submit()" class="btn btn-primary">${uiLabelMap.CommonFind}</a>
          </td>
        </tr>
      </table>
    </form>
