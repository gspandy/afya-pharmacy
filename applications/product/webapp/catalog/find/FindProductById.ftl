...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        <form name="idsearchform" method="post" action="<@ofbizUrl>FindProductById</@ofbizUrl>" style="margin: 0;">
          <span class="label">${uiLabelMap.CommonId} ${uiLabelMap.CommonValue}:</span> <input type="text" name="idValue" size="20" maxlength="50" value="${idValue?if_exists}" />&nbsp;<a href="javascript:document.idsearchform.submit()" class="btn btn-primary">${uiLabelMap.CommonFind}</a>
        </form>
        <br />
        ...
        <#else/>
          <table cellspacing="0" class="basic-table">
            ...
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                ...
                <td>&nbsp;&nbsp;</td>
                <td>
                    <a href="<@ofbizUrl>EditProduct?productId=${idProduct.productId}</@ofbizUrl>" class="btn-link">${(idProduct.internalName)?if_exists}</a>
            ...
            <#list goodIdentifications as goodIdentification>
                ...
                <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                    ...
                    <td>&nbsp;&nbsp;</td>
                    <td>
                        <a href="<@ofbizUrl>EditProduct?productId=${product.productId}</@ofbizUrl>" class="btn-link">${(product.internalName)?if_exists}</a>
