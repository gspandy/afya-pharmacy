...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    ...
    <div><a href="<@ofbizUrl>advancedsearch?SEARCH_CATEGORY_ID=${(requestParameters.SEARCH_CATEGORY_ID)?if_exists}</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonRefineSearch}</a></div>
        ...
        <#list productIds as productId><#-- note that there is no boundary range because that is being done before the list is put in the content -->
          ...
          <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
            <td>
              ...
              <a href="<@ofbizUrl>EditProduct?productId=${productId}</@ofbizUrl>" class="btn-link">[${productId}] ${(product.internalName)?if_exists}</a>
            </td>
          </tr>
