      ...
      <#--  <div class="button-bar">
        ...
        <form action="<@ofbizUrl>QuickAddProductFeatures</@ofbizUrl>" method="post">
          <div>
            ...
            <input class="btn btn-success" type="submit" value="${uiLabelMap.CommonCreate}" />
          </div>
    ...
    <div class="screenlet-body">
        ...
        <#if (listSize > 0)>
            ...
            <tr id="productFeatureId_tableRow_${rowCount}" valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
              ...
              <a href="<@ofbizUrl>EditFeature?productFeatureId=${productFeature.productFeatureId}</@ofbizUrl>" class="btn-link">${productFeature.productFeatureId}</a></td>
            ...
            <input type="submit" class="btn btn-success" value='${uiLabelMap.CommonUpdate}'/></td></tr>
        </#if>
        </table>
        </form>
    </div>
