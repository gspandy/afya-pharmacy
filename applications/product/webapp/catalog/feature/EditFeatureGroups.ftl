        ...
        <table cellspacing="0" class="basic-table">
          ...
          <#list productFeatureGroups as productFeatureGroup>
            <tr valign="middle"<#if rowClass == "1"> class="alternate-row"</#if>>
                <td><a href='<@ofbizUrl>EditFeatureGroupAppls?productFeatureGroupId=${productFeatureGroup.productFeatureGroupId}</@ofbizUrl>' class="btn-link">${productFeatureGroup.productFeatureGroupId}</a></td>
                <td>
    ...
    <div class="screenlet-body">
        <form method="post" action="<@ofbizUrl>CreateProductFeatureGroup</@ofbizUrl>">
          ...
          <table cellspacing="0" class="basic-table">
            ...
            <tr>
              <td></td>
              <td colspan='2'><input type="submit" value="${uiLabelMap.CommonCreate}" class="btn btn-success" /></td>
            </tr>
          </table>
        </form>
        <br />
