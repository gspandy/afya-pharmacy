...
//              Debug.log("=====product found:" + productId + " and features: " + selectedFeatures);
    ...
    public static Map<String,Object> getAtpQoh(LocalDispatcher dispatcher,GenericValue userLogin,String productId, String facilityId) throws GenericServiceException{
		Map<String,Object> resultOutput = dispatcher.runSync("getInventoryAvailableByFacility", UtilMisc.toMap("userLogin",userLogin,"productId",productId, "facilityId", facilityId));
		Object qoh = resultOutput.get("quantityOnHandTotal");
		Object atp = resultOutput.get("availableToPromiseTotal");
