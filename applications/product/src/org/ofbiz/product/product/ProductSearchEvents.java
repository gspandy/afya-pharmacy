    ...
    public static String searchAddFeature(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            try {
                ...
                messageMap.put("numAdded",String.valueOf(numAdded));
                messageMap.put("productFeatureId", productFeatureId);
    ...
    public static String searchRemoveFeature(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            try {
                ...
                Map<String, String> messageMap = UtilMisc.toMap("numRemoved", String.valueOf(numRemoved), "productFeatureId", productFeatureId);
