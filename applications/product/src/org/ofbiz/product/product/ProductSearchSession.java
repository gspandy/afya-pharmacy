...
public class ProductSearchSession {
    ...
    public static List<Map<String, String>> listCountByFeatureForType(String productFeatureTypeId, HttpSession session, Delegator delegator) {
        ...
        while ((searchResult = eli.next()) != null) {
	        ...
	        m.put("productFeatureId", (String)searchResult.get("pfacProductFeatureId"));
	        m.put("productFeatureTypeId", (String)searchResult.get("pfcProductFeatureTypeId"));
	        m.put("description", (String)searchResult.get("pfcDescription"));
	        m.put("featureCount", Long.toString((Long) searchResult.get("featureCount")));
            featureCountList.add(m);
        }
