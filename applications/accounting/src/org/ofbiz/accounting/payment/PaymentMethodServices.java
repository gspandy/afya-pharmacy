...
public class PaymentMethodServices {
    ...
    public static Map scheduleAcctgTransaction(DispatchContext ctx, Map context) throws GenericEntityException, GenericServiceException {
        Map result = new HashMap();
        Delegator delegator = ctx.getDelegator();
        LocalDispatcher dispatcher = ctx.getDispatcher();
        GenericValue userLogin = (GenericValue) context.get("userLogin");
        Timestamp now = UtilDateTime.nowTimestamp();
        String acctgTemplateId = (String) context.get("acctgTemplateId");
        String organizationPartyId = (String) context.get("organizationPartyId");
        Map createAcctgTransMap;
        if(UtilValidate.isNotEmpty(acctgTemplateId)){
        	GenericValue acctgTemplateGv = delegator.findOne("AcctgTemplate", true, UtilMisc.toMap("acctgTemplateId",acctgTemplateId));
        	Map<String, Object> acctgTransServiceCtx = new HashMap<String, Object>();
        	acctgTransServiceCtx.put("userLogin", userLogin);
        	acctgTransServiceCtx.put("acctgTransTypeId", acctgTemplateGv.getString("acctgTransTypeId"));
        	acctgTransServiceCtx.put("transactionDate", now);
        	acctgTransServiceCtx.put("glFiscalTypeId", "ACTUAL");
        	acctgTransServiceCtx.put("postedDate", now);
        	acctgTransServiceCtx.put("createdByUserLogin", userLogin.getString("userLoginId"));
        	acctgTransServiceCtx.put("lastModifiedByUserLogin", userLogin.getString("userLoginId"));
        	acctgTransServiceCtx.put("invoiceId", acctgTemplateGv.getString("invoiceId"));
        	acctgTransServiceCtx.put("paymentId", acctgTemplateGv.getString("paymentId"));
        	acctgTransServiceCtx.put("description", acctgTemplateGv.getString("comments"));
        	acctgTransServiceCtx.put("acctgTemplateId", acctgTemplateId);
        	
        	List<GenericValue> acctgTemplateEntriesList = delegator.findByAnd("AcctgTemplateEntries", UtilMisc.toMap("acctgTemplateId",acctgTemplateId,"organizationPartyId",organizationPartyId), null, true);
        	List<Map<String, Object>> acctgTransEntries = new ArrayList<Map<String,Object>>();
        	for(GenericValue acctgTemplateEntriesGv : acctgTemplateEntriesList){
        		Map<String, Object> acctgTransEntryServiceCtx = new HashMap<String, Object>();
        		acctgTransEntryServiceCtx.put("organizationPartyId", organizationPartyId);
        		acctgTransEntryServiceCtx.put("debitCreditFlag", acctgTemplateEntriesGv.get("debitCreditFlag"));
        		acctgTransEntryServiceCtx.put("glAccountId", acctgTemplateEntriesGv.getString("glAccountId"));
        		acctgTransEntryServiceCtx.put("amount", acctgTemplateEntriesGv.getString("amount"));
        		acctgTransEntryServiceCtx.put("description", acctgTemplateEntriesGv.get("description"));
        		acctgTransEntries.add(acctgTransEntryServiceCtx);
        	}
        	acctgTransServiceCtx.put("acctgTransEntries", acctgTransEntries);
        	dispatcher.runSync("createAcctgTransAndEntries", acctgTransServiceCtx);
