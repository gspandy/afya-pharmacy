<#escape x as x?xml>
    ...
    <fo:block font-size="15pt" text-align="center" font-weight="bold">Customer Aging</fo:block>
    <#-- blank line -->
                ...
                <fo:table-body>
                    ...
                    <#list invoicePaymentInfoList as invoicePaymentInfo>
                        <fo:table-row text-align="center" height="15pt">
                            ...
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block margin-top="3px">
                                 <#if invoicePaymentInfo.partyId?has_content>
                                 <#assign partyGroup = delegator.findOne("PartyGroup",{"partyId",invoicePaymentInfo.partyId},false)>
