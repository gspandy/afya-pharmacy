    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <fo:page-sequence master-reference="11x17-landscape">
            <fo:flow flow-name="xsl-region-body" font-family="Helvetica">
                <fo:block align="center">${screens.render("component://accounting/widget/GlScreens.xml#ZPCHeader")}</fo:block>
                    ...
                    <fo:block>
                        <fo:table>
                            ...
                            <fo:table-header>
                                ...
                                <fo:table-cell border="1pt solid" border-width=".1mm">
                                    <fo:block text-align="center" font-size="6pt">${uiLabelMap.FormFieldTitle_reconcileStatus}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid" border-width=".1mm">
                                <fo:block text-align="right" margin-right="25px" font-size="6pt">${uiLabelMap.AccountingAmount}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid" border-width=".1mm">
                            ...
                            <fo:table-body>
                                <#list acctgTransEntryList as acctgTransEntry>
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell border="1pt solid" border-width=".1mm">
                                            <fo:block text-align="center" font-size="5pt">
                                                <#if (acctgTransEntry.glAccountId)??>
                                                    <#assign accountDescription = (delegator.findOne("GlAccount", {"glAccountId" : (acctgTransEntry.glAccountId)!}, false))!/>
                                                    <#if accountDescription?has_content>${accountDescription.accountName}</#if>
                                                </#if>
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell border="1pt solid" border-width=".1mm">
                                        ...
                                        <fo:table-cell border="1pt solid" border-width=".1mm">
                                            <fo:block text-align="center" font-size="5pt">
                                                <#if (acctgTransEntry.reconcileStatusId)??>
                                                    <#assign reconcileStatusType = (delegator.findOne("StatusItem", {"statusId" : (acctgTransEntry.reconcileStatusId)!}, false))!/>
                                                    <#if reconcileStatusType?has_content>${reconcileStatusType.description}</#if>
                                                </#if>
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell border="1pt solid" border-width=".1mm">
                                            <fo:block text-align="right" margin-right="15px" font-size="5pt"><#if acctgTransEntry.amount?exists><@ofbizCurrency amount=(acctgTransEntry.amount)! isoCode=(acctgTransEntry.currencyUomId)!/></#if></fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell border="1pt solid" border-width=".1mm">
                                            <fo:block text-align="center" font-size="5pt">
