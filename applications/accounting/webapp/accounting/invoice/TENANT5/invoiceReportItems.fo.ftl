     ...
     <#assign count = 0>
        ...
        <#list invoiceItems as invoiceItem>
            ...
            <#if !isItemAdjustment>
	            ...
	            <fo:table-row height="13px" space-start=".15in">
                    ...
                    <fo:table-cell border-right-style="solid" border-right-width="thin" border-right-color="black">
                        <fo:block text-align="right" font-weight="bold"> <#if invoiceItem.quantity?exists>${invoiceItem.quantity?string.number}</#if> <#if quantityUom?exists>${quantityUom}</#if> </fo:block>
                    </fo:table-cell>
        ...
        <#list taxAdjustments as taxAdj>
        	  <fo:table-row height="12px" space-start=".15in">
                    ...
                    <fo:table-cell border-right-style="solid" border-right-width="thin" border-right-color="black">
                        <fo:block text-align="right" font-weight="bold">${taxAdj.comments?if_exists}</fo:block>
                    </fo:table-cell>
                    <fo:table-cell text-align="center" border-right-style="solid" border-right-width="thin" border-right-color="black">
                        <fo:block>  </fo:block>
                    </fo:table-cell>
                     <fo:table-cell text-align="right" border-right-style="solid" border-right-width="thin" border-right-color="black">
                        <fo:block>${taxAdj.sourcePercentage?if_exists} <#if taxAdj.sourcePercentage?has_content> % </#if> </fo:block>
                    </fo:table-cell>
                    <fo:table-cell text-align="right" border-right-style="solid" border-right-width="thin" border-right-color="black">
                        <fo:block></fo:block>
                    </fo:table-cell>
                     <fo:table-cell text-align="right" border-right-style="solid" border-right-width="thin" border-right-color="black">
                        <fo:block font-weight="bold"> <@ofbizCurrency amount=taxAdj.amount?if_exists isoCode=invoice.currencyUomId?if_exists /> </fo:block>
                    </fo:table-cell>
               </fo:table-row>
         </#list>
        <#-- blank line -->
