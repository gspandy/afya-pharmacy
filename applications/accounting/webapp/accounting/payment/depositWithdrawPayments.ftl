        ...
        <#if paymentList?has_content>
            ...
            <table class="basic-table">
                <tr class="header-row-2">
                    ...
                    <td>${uiLabelMap.AccountingPaymentStatus}</td>
                ...
                <#list paymentList as payment>
                    <tr <#if alt_row> class="alternate-row"</#if>>
                        ...
                        <td>${payment.statusId?if_exists}</td>
                ...
                <div align="right">
                    ...
                    <input id="submitButton" type="button" class="btn btn-success" onclick="javascript:document.depositWithdrawPaymentsForm.submit();" value="${uiLabelMap.AccountingDepositWithdraw}" disabled="disabled"/>
                </div>
            </table>
        <#else>
