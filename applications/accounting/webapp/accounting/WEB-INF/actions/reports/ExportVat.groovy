...
PreparedStatement statement = conn.prepareStatement("SELECT DISTINCT invoiceId,invoiceDate,invoiceTypeId,statusId,billOfEntry,customerPartyId,customerName,tPin,geo,country, \n" +
