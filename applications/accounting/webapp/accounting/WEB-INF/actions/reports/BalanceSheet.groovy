...
GenericValue timePeriodGv = delegator.findOne("CustomTimePeriod",UtilMisc.toMap("customTimePeriodId",customTimePeriodId),false);
Timestamp thruDate = timePeriodGv!=null ? new Timestamp(timePeriodGv.getDate("thruDate").getTime()):UtilDateTime.nowTimestamp();
...
accountBalanceList = UtilMisc.sortMaps(transactionTotalsMap.values().asList(), UtilMisc.toList("accountCode"));
println "Asset accountBalanceList " + accountBalanceList;
...
accountBalanceList = UtilMisc.sortMaps(transactionTotalsMap.values().asList(), UtilMisc.toList("accountCode"));
println "Liability accountBalanceList " + accountBalanceList;
accountBalanceList.each { accountBalance ->
    balanceTotal = balanceTotal + accountBalance.balance;
}
