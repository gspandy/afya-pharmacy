...
PreparedStatement statement = conn.prepareStatement("SELECT DISTINCT invoiceId,invoiceDate,invoiceTypeId,statusId,supplierInvoiceNumber,supplierPartyId,supplierName,tPin,geo,country, \n" +
	...
	"\t I.`STATUS_ID` AS statusId,I.`DESCRIPTION` AS description,I.`REFERENCE_NUMBER` AS supplierInvoiceNumber, \n" +
	...
	"\t AND ATE.`GL_ACCOUNT_ID` NOT IN ('9500000','9000000')) T WHERE vatAmount IS NOT NULL AND geo = 'ZMB' \n" +
