  ...
  <div class="screenlet"> 
    ...
    <div class="screenlet-body">
      ...
      <#if finAcctTransCondList?has_content>
        <a href="javascript:document.CancelBankReconciliationForm.submit();" class="btn btn-danger">${uiLabelMap.AccountingCancelBankReconciliation}</a>
      </#if>
          ...
          <#list finAccountTransList as finAccountTrans>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
              ...
              <#if finAccountTrans.statusId == "FINACT_TRNS_CREATED">
                <td align="center"><a href="javascript:document.reomveFinAccountTransAssociation_${finAccountTrans.finAccountTransId}.submit();" class="btn btn-danger">${uiLabelMap.CommonRemove}</a></td>
              <#else>
                <td/>
              </#if>
              <#if finAccountTrans.paymentId?has_content>
                <td align="center">
                  <a id="toggleGlTransactions_${finAccountTrans.finAccountTransId}" href="javascript:void(0)" class="btn-link">${uiLabelMap.FormFieldTitle_glTransactions}</a>
