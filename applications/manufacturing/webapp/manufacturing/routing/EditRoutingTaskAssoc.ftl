    ...
    <table class="basic-table" cellspacing="0">
        <tr>
            ...
            <td>
                ...
                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="addtaskassocform"/>
            </td>
        ...
        <tr>
            <td >&nbsp;</td>
            <td colspan="3">
                <a href="javascript:addRoutingTask();" class="btn btn-success">${uiLabelMap.ManufacturingAddExistingRoutingTask}</a>
                &nbsp;-&nbsp;
                <a href="javascript:copyAndAddRoutingTask();" class="btn btn-success">${uiLabelMap.ManufacturingCopyAndAddRoutingTask}</a>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
