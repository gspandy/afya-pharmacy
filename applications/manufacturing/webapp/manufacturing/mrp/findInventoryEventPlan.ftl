              ...
              <td align='right'>
                <p>
                  <#if requestParameters.hideFields?default("N") == "Y">
                    <a href="<@ofbizUrl>FindInventoryEventPlan?hideFields=N${paramList}</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonShowLookupFields}</a>
                  <#else>
                    <#if inventoryList?exists>
                        <a href="<@ofbizUrl>FindInventoryEventPlan?hideFields=Y${paramList}</@ofbizUrl>" class="buttontext">${uiLabelMap.CommonHideFields}</a>
                    </#if>
                  </#if>
                </p>
              </td>
              ...
              <td align='center' width='100%'>
                 <table class="basic-table" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td width="5%">&nbsp;</td>
                    <td width="75%"> <a href="javascript:lookupInventory();" class="btn btn-primary">&nbsp; ${uiLabelMap.CommonFind} &nbsp;</a></td>
                  </tr>
                </table>
              </td>
            </tr>
