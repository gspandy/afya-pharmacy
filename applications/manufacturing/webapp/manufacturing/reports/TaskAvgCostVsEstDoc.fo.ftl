...
<#if productionRunList?has_content>
        ...
        <fo:flow flow-name="xsl-region-body" font-family="Helvetica">
            <fo:block font-size="14pt" margin-bottom="0.2in">Production Run's and Tasks Estimation Cost And Actual Cost </fo:block>
               ...
               <#-- <fo:table-column column-width="95pt"/>  -->
                ...
                <fo:table-header>
                    <fo:table-row font-weight="bold">
                        ...
                        <fo:table-cell border-bottom="thin solid grey"><fo:block>Task Type</fo:block></fo:table-cell>
                ...
                <fo:table-body>
                    ...
                    <#list productionRunList as productRun>
                    	<#if productRun.workEffortTypeId == 'PROD_ORDER_HEADER'>
                        ...
                        <fo:table-row border-bottom="thin solid grey">
                           <#--  <fo:table-cell padding="2pt" background-color="${rowColor}">
                            ...
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block>${productRun.workEffortTypeId}</fo:block>
                            </fo:table-cell> 
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                            ...
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block>${productRun.averageEstimatedCost?if_exists}</fo:block>
                            </fo:table-cell>
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                <fo:block>${productRun.averageActualCost?if_exists}</fo:block>
                            </fo:table-cell>
                        </fo:table-row>                        
