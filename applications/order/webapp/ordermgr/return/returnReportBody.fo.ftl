...
<#macro displayReturnAdjustment returnAdjustment>
    ...
    <fo:table-cell padding="1mm" text-align="right"><fo:block font-family="Rupee,Arial"><@ofbizCurrency amount=returnAdjustment.amount isoCode=returnHeader.currencyUomId/></fo:block></fo:table-cell>
    </fo:table-row>
          ...
          <fo:table-body>
            ...
            <#list returnItems as returnItem>
              <fo:table-row>
                ...
                <fo:table-cell padding="1mm" text-align="right"><fo:block font-family="Rupee,Arial"><@ofbizCurrency amount=returnItem.returnPrice isoCode=returnHeader.currencyUomId/></fo:block></fo:table-cell>
                <fo:table-cell padding="1mm" text-align="right"><fo:block font-family="Rupee,Arial"><@ofbizCurrency amount=(returnItem.returnPrice * returnItem.returnQuantity) isoCode=returnHeader.currencyUomId/></fo:block></fo:table-cell>
              </fo:table-row>
          ...
          <fo:table-body>
            <fo:table-row>
              ...
              <fo:table-cell text-align="right" padding="1mm" border-style="solid" border-width="0.2pt">
                <fo:block font-family="Rupee,Arial"><@ofbizCurrency amount=total isoCode=returnHeader.currencyUomId/></fo:block>
              </fo:table-cell>
            </fo:table-row>
          </fo:table-body>
        </fo:table>
