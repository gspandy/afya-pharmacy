          ...
          <table cellspacing="0" class="basic-table">
            <tr><td>
              ...
              <#if (party.partyId)?has_content>
                 <a href="/partymgr/control/editcreditcard?partyId=${party.partyId}${externalKeyParam}" target="partymgr" class="btn btn-link btn-mini">${uiLabelMap.AccountingCreateNewCreditCard}</a>
              </#if>
            </td></tr>
          </table>
          </#if> -->
