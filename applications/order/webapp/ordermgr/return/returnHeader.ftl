          ...
          <tr>
            ...
            <td width='74%'>
              <#if returnInfo.entryDate?exists>
                ...
                <@htmlTemplate.renderDateTimeField name="entryDate" value="${entryDate!''}" className="" alert="" 
                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="entryDate" dateType="date" shortDateInput=false 
                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="returnhead"/>
          ...
          <tr>
            ...
            <td width='74%'>
              ...
              <#if (returnHeader.fromPartyId)?has_content>
                <a href="/partymgr/control/editcreditcard?partyId=${returnHeader.fromPartyId}${externalKeyParam}" target="partymgr" class="btn btn-primary">${uiLabelMap.AccountingCreateNewCreditCard}</a>
              </#if>
            </td>
          </tr>
          <tr>
