...
quoteItems.each { quoteItem ->
    ...
    percProfit = averageCost != 0 ? decimalFormat.format((profit / averageCost) * 100.00) : 0.00;
...
context.decimalFormat = decimalFormat;
context.totalPercProfit = totalCost != 0 ? (decimalFormat.format (  ((totalPrice - totalCost) / totalCost) * 100.00) ): 0.00 ;
