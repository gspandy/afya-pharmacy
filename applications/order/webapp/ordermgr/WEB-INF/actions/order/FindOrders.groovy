...
EntityCondition purchaseCondition = EntityCondition.makeCondition("orderTypeId", EntityOperator.EQUALS, "PURCHASE_ORDER");
//EntityCondition bothPurchaseCondition = EntityCondition.makeCondition(purchaseCondition,EntityOperator.OR,EntityCondition.makeCondition("orderTypeId", EntityOperator.EQUALS, "RESERVE_ORDER"));
    								
EntityCondition salesCondition = EntityCondition.makeCondition("orderTypeId", EntityOperator.EQUALS, "SALES_ORDER");
//EntityCondition bothSalesCondition = EntityCondition.makeCondition(salesCondition,EntityOperator.OR,EntityCondition.makeCondition("orderTypeId", EntityOperator.EQUALS, "RESERVE_ORDER"));

if("PURCHASE_ORDER".equals(type))
orderTypes = delegator.findList("OrderType", purchaseCondition, null, ["description"], null, false);

if("SALES_ORDER".equals(type))
orderTypes = delegator.findList("OrderType", salesCondition, null, ["description"], null, false);
