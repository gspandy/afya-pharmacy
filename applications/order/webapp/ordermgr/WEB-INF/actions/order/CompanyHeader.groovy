...
GenericValue partyMenuFacUnit = delegator.findByPrimaryKey("PartyMenufacturerUnit",UtilMisc.toMap("partyId",partyId));
context.partyMenuFacUnit = partyMenuFacUnit;
