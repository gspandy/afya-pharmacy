    ...
    <table class="basic-table" cellspacing='0'>
        ...
        <td>
          <#if state.hasPrevious()>
            <a href="<@ofbizUrl>orderlist?viewIndex=${state.getViewIndex() - 1}&amp;viewSize=${state.getViewSize()}&amp;filterDate=${filterDate?if_exists}</@ofbizUrl>" class="btn btn-link">${uiLabelMap.CommonPrevious}</a>
          </#if>
        </td>
        <td align="right">
          <#if state.hasNext()>
            <a href="<@ofbizUrl>orderlist?viewIndex=${state.getViewIndex() + 1}&amp;viewSize=${state.getViewSize()}&amp;filterDate=${filterDate?if_exists}</@ofbizUrl>" class="btn btn-link">${uiLabelMap.CommonNext}</a>
          </#if>
        </td>
      </tr>
    </table>
    ...
    <div class="screenlet-body">
      <form method="post" name="findorder" action="<@ofbizUrl>orderlist</@ofbizUrl>">
        ...
        <table class="basic-table" cellspacing='0'>
          ...
          <tr>
            <td colspan="3" align="center">
              <a href="javascript:document.findorder.submit()" class="btn btn-primary">${uiLabelMap.CommonFind}</a>
            </td>
          </tr>
        </table>
      </form>
    ...
    <div class="screenlet-body">
      ...
      <div align="right">
        ...
        <select name="serviceName" onchange="javascript:setServiceName(this);">
           ...
           <option value="<@ofbizUrl>massVoucherExport</@ofbizUrl>">Export Vouchers</option>
        </select>
        ...
        <table class="basic-table hover-bar" cellspacing='0'>
          ...
          <#list orderHeaderList as orderHeader>
            ...
            <tr>
              ...
              <td>
                <a href="<@ofbizUrl>orderview?orderId=${orderHeader.orderId}</@ofbizUrl>" class="btn-link">${orderHeader.orderId}</a>
              </td>
