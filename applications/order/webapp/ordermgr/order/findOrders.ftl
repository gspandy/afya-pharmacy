...
<form name='lookupandhidefields${requestParameters.hideFields}' method="post" action="<@ofbizUrl>searchorders</@ofbizUrl>">
  ...
  <input type='hidden' name='orderName' value='${requestParameters.orderName?if_exists}'/>
</form>
</#if>
          ...
          <td align='center' width='100%'>
            <table class="basic-table" cellspacing='0'>
              ...
              <tr>
                ...
                <td width='5%'>&nbsp;</td>
                <td align='left'><input type='text' name='orderName' value='${requestParameters.orderName?if_exists}'/></td>
              </tr>
             <!--<tr>
             ...
             <tr>
              ...
              <tr>
                ...
                <td align='left'>
                    ...
                    <input type='submit' class="btn btn-primary" value='${uiLabelMap.CommonFind}'/>
                </td>
              </tr>
            </table>
          </td>
        ...
        <#if orderList?has_content>
          ...
          <#list orderList as orderHeader>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
             ...
             <!--  <td align='right'>
                <a href="<@ofbizUrl>orderview?orderId=${orderHeader.orderId}</@ofbizUrl>" class='btn btn-primary'>${uiLabelMap.CommonView}</a>
              </td> -->
            </tr>
