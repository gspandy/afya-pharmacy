                  ...
                  <tr class="${rowStyle}">
                    ...
                    <td nowrap="nowrap">
                      <div>&nbsp;
                        ...
                        <a href="<@ofbizUrl>paysetup?webSiteId=${paymentSetting.webSiteId?if_exists}&amp;paymentMethodTypeId=${paymentSetting.paymentMethodTypeId?if_exists}</@ofbizUrl>" class="btn btn-success">Edit</a>&nbsp;
                        </#if>
                        <#if security.hasEntityPermission("PAYPROC", "_DELETE", session)>
                        <a href="<@ofbizUrl>removeWebSitePaymentSetting?webSiteId=${paymentSetting.webSiteId?if_exists}&amp;paymentMethodTypeId=${paymentSetting.paymentMethodTypeId?if_exists}</@ofbizUrl>" class="btn btn-danger">Remove</a>&nbsp;
                        </#if>
                      </div>
                    </td>
                  </tr>
