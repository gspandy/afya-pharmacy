                ...
                <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                    <td valign="top">
                        <div>
                            <#if showRequestManagementLinks?exists>
                                <a href="<@ofbizUrl>EditRequestItem?custRequestId=${requestItem.custRequestId}&amp;custRequestItemSeqId=${requestItem.custRequestItemSeqId}</@ofbizUrl>" class="btn-link">${requestItem.custRequestItemSeqId}</a>
                            <#else>
                    ...
                    <td valign="top">
                        <div>
                            ...
                            <#if showRequestManagementLinks?exists>
                                <a href="/catalog/control/EditProduct?productId=${requestItem.productId?if_exists}" class="btn-link">${requestItem.productId?if_exists}</a>
                            <#else>
                                <a href="<@ofbizUrl>product?product_id=${requestItem.productId?if_exists}</@ofbizUrl>" class="btn-link">${requestItem.productId?if_exists}</a>
                            </#if>
                        </div>
                    </td>
