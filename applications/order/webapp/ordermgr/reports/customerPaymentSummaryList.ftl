<div class="screenlet">
    ...
    <table cellspacing="0" cellpadding="2" class="basic-table">
            <tr class="header-row">
                <td><fo:block text-align="center">Opening Balance</fo:block></td>
                <td><fo:block text-align="center">Currency</fo:block></td>
                <td><fo:block text-align="center">Payments</fo:block></td>
                <td><fo:block text-align="center">Invoices</fo:block></td>
                <td><fo:block text-align="center">Closing Balance</fo:block></td>
            </tr>
        <#assign partyId = "">
            ...
            <#if partyId == value.partyId>
                ...
                <tr>
                    ...
                    <#if value.credit lt 0>
                    	...
                    	<#else>
                    	<block text-align="right">${value.credit?string("#,##0.00")}</block>
                    </#if>
                    </td>
                    <td>
                    <#if value.debit lt 0>
                    	...
                    	<#else>
                    	<block text-align="right">${value.debit?string("#,##0.00")}</block>
                    </#if>
                    </td>
                    ...
                    <td>
                     <#if closingBalance lt 0>
                    	...
                    	<block text-align="right">${closingBalance?string("#,##0.00")} DR</block>
                    	<#else>
                    	<block text-align="right">${closingBalance?string("#,##0.00")}</block>
                    </#if>
                    </td>
                </tr>
            </#list>
    ...
    <#else>
    <block text-align="center">No Record Found.</fo:block>
    </#if>
