<#escape x as x?xml>
<fo:block font-size="15pt" text-align="center" font-weight="bold">Supplier Payment Detail</fo:block>
               ...
               <#list list as map>
                <fo:table-row>
                    ...
                    <fo:table-cell border="solid black">
                      ...
                      ${map.transactionId}
                      <#-- <#if "VENDOR_PAYMENT" == map.transactionType || "VENDOR_PREPAY" == map.transactionType>
                    ...
                    <fo:table-cell border="solid black">
                    	<#if "VENDOR_PAYMENT" == map.transactionType || "VENDOR_PREPAY" == map.transactionType || "DEBIT_MEMO" == map.transactionType>
