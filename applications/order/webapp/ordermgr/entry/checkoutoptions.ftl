    ...
    <tr valign="top">
      <td height="100%">
        <div class="screenlet" style="height: 100%;">
            <div class="screenlet-title-bar">
                <#if shipping == true>
                    <div class="h3">&nbsp;${uiLabelMap.OrderWhereShallWeShipIt}?</div>
                <#else>
                    <div class="h3">&nbsp;${uiLabelMap.OrderInformationAboutYou}</div>
                </#if>
            </div>
                       ...
                       <tr>
                         ...
                         <td valign="top" width="100%" nowrap="nowrap">
                           <div>
                            ...
                            <!-- <a href="javascript:submitForm(document.checkoutInfoForm, 'EA', '${shippingAddress.contactMechId}');" class="btn btn-success">${uiLabelMap.CommonUpdate}</a> -->
                           </div>
                         </td>
                       </tr>
         ...
         <div class="screenlet" style="height: 100%;">
            <div class="screenlet-title-bar">
                    <div class="h3">Where shall we ship from?</div>
            </div>
	            <div class="screenlet-body" style="height: 100%;">
	                <table width="100%" border="0" cellpadding="1" cellspacing="0">
	                  <tr>
	                    <td colspan="4">
	                      <span>Ship Origin Location</span>
	                    </td>
	                   </tr>
                  ...
                  <tr>
                    <td valign="top" nowrap="nowrap">
                      <input type="radio" name="shipping_origin_contact_mech_id" value="${shippingAddress.contactMechId}" 
                      	onclick="javascript:submitForm(document.checkoutInfoForm, 'SA', null);" <#if shoppingCart.getShippingOriginContactMechId()?default("")==shippingAddress.contactMechId> checked="checked" </#if>/>
                    </td>
                    <td nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td valign="top" width="100%" nowrap="nowrap">
                      <div>
      ...
      <td height="100%">
        <div class="screenlet" style="height: 100%;">
            <div class="screenlet-title-bar">
                <#if shipping == true>
                    <div class="h3">&nbsp;${uiLabelMap.OrderHowShallWeShipIt}?</div>
                <#else>
                    <div class="h3">&nbsp;${uiLabelMap.OrderOptions}?</div>
                </#if>
            </div>
            <div class="screenlet-body" style="height: 100%;">
                <table width="100%" cellpadding="1" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <#list carrierShipmentMethodList as carrierShipmentMethod>
                    ...
                    <tr>
                      <td width="1%" valign="top">
                        <input type="radio" name="shipping_method" style="margin-bottom: 7px;" value="${shippingMethod}" <#if shippingMethod == chosenShippingMethod?default("N@A")>checked="checked"</#if>/>
                      </td>
                      <td valign="top">
                        <div>
                 ...
                 <input style="display:none;" type="radio" <#if shoppingCart.getMaySplit()?default("N") == "N">checked="checked"</#if> name="may_split" value="false"/>
                  <!-- <tr><td colspan="2"><hr /></td></tr>
                  <tr>
                    <td colspan="2">
            ...
            <div class="screenlet-body" style="height: 100%;">
                <table width="100%" cellpadding="1" cellspacing="0" border="0">
                 <!-- <tr>
                  ...
                  <tr>
                    <td width="1%" valign="top">
                      <input type="radio" name="checkOutPaymentId" value="PRE_PAID" <#if "PRE_PAID" == checkOutPaymentId>checked="checked"</#if>/>
                      <span>Pre-Paid</span>
                    </td>
                  </tr>
                  </#if>
                 ...
                 <!-- <#if productStorePaymentMethodTypeIdMap.CREDIT_CARD?exists>
                  <tr>
                    <td width="1%">
                      <input type="radio" name="checkOutPaymentId" value="CREDIT_CARD" <#if "CREDIT_CARD" == checkOutPaymentId>checked="checked"</#if>/>
                    </td>
                    <td width="50%">
                    ...
                    <!-- <#elseif paymentMethod.paymentMethodTypeId == "GIFT_CARD">
                     ...
                     <!-- <tr>
                        ...
                        <td width="50%">
                          ...
                          <a href="javascript:submitForm(document.checkoutInfoForm, 'EG', '${paymentMethod.paymentMethodId}');" class="btn btn-success">[${uiLabelMap.CommonUpdate}]</a>
                          <#if paymentMethod.description?has_content><br /><span>(${paymentMethod.description})</span></#if>
                        </td>
                      </tr>
                     </#if> -->
                  ...
                  <#if billingAccountList?has_content>
                    ...
                    <tr>
                      <td >
                        ...
                        <select name="billingAccountId" style="max-width:100px;margin-left:40px;">
                          <option value=""></option>
