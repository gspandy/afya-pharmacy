...
function markOrderViewed() {
	waitSpinnerShow();
	$.ajax({url:'/ordermgr/control/markOrderViewed',data: $('orderViewed').serialize(),
...
function markOrderInterstatePurchase() {
	waitSpinnerShow();
	$.ajax({url:'markOrderInterstatePurchase',asynchronous: true,data: $('interstatePurchaseForm').serialize(),
        onSuccess: function() {
        }
    });
      waitSpinnerHide();
...
function setOrderHeaderInfo() {
	waitSpinnerShow();
	$.ajax({url:'/ordermgr/control/setOrderName',data: $('#setCartOrderNameForm').serializeArray(),
        onSuccess: function() {
        }
    });
    waitSpinnerHide();
...
function setPONumber() {
	waitSpinnerShow();
	$.ajax({url:'/ordermgr/control/setPoNumber',asynchronous: true,data: $('#setCartPoNumberForm').serialize(),
        onSuccess: function() {
        }
    });
    waitSpinnerHide();
