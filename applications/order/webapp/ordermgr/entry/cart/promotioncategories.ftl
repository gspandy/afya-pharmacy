    ...
    <div class="screenlet-body">
        <#if productPromoCategoryIncludeList?has_content>
          ...
          <#list productPromoCategoryIncludeList as productPromoCategory>
            ...
            <div>
                -&nbsp;<a href="<@ofbizUrl>category/~category_id=${productPromoCategory.productCategoryId}</@ofbizUrl>" class="btn-link">${(productCategory.description)?default(productPromoCategory.productCategoryId)}</a>
