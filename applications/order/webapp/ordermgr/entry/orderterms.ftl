                            ...
                            <table class="basic-table hover-bar">
                                ...
                                <#list orderTerms as orderTerm>
                                    <tr <#if orderTerm_index % 2 != 0>class="alternate-row"</#if> >
                                        ...
                                        <td align="right">
                                            <a href="<@ofbizUrl>setOrderTerm?termIndex=${orderTerm_index}&amp;createNew=Y</@ofbizUrl>" class="btn btn-success">${uiLabelMap.CommonUpdate}</a>
                                            <a href="<@ofbizUrl>removeCartOrderTerm?termIndex=${orderTerm_index}</@ofbizUrl>" class="btn btn-danger">${uiLabelMap.CommonRemove}</a>
                                        </td>
                                    </tr>
                                </#list>
                                <tr>
                                    <td colspan="5">
                                        <a href="<@ofbizUrl>setOrderTerm?createNew=Y</@ofbizUrl>" class="btn btn-success">${uiLabelMap.CommonCreateNew}</a>
                                    </td>
                                </tr>
                            </table>
                        <#else>
                            <form method="post" action="<@ofbizUrl>addOrderTerm</@ofbizUrl>" name="termform">
                                ...
                                <table class="basic-table">
                                    ...
                                    <tr>
                                        ...
                                        <td width="5">&nbsp;</td>
                                        <td width="74%">
                                            <input type="submit" class="btn btn-success" value="${uiLabelMap.CommonAdd}" />
                                        </td>
                                    </tr>
                                </table>
                            </form>
