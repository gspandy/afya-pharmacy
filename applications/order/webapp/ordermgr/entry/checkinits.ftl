...
<div class="screenlet">
  ...
  <div class="screenlet-body">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="boxbottom">
       <tr>
          <td>&nbsp;</td>
          <td class="label" align='right' valign='middle' nowrap="nowrap"><div class='tableheadtext'>Order Flow</div></td>
          <td>&nbsp;</td>
          <td valign='middle'>
            <div class='tabletext'>
        ...
        <tr>
          <td >&nbsp;</td>
          <td class="label" width="300" align='right' valign='middle' nowrap="nowrap"><div class='tableheadtext'>${uiLabelMap.ProductProductStore}</div></td>
          <td >&nbsp;</td>
          <td valign='middle'>
            <div class='tabletext'>
        ...
        <input value='${parameters.userLogin.userLoginId}' name="userLoginId" type="hidden"/>
         <tr>
          <td>&nbsp;</td>
          <td class="label" align='right' valign='middle' nowrap="nowrap"><div class='tableheadtext'>${uiLabelMap.OrderCustomer} <span><font color="red">*</font></div></td>
          <td>&nbsp;</td>
          <td valign='middle'>
            <div class='tabletext'>
        ...
        <tr>
          <td>&nbsp;</td>
          <td class="label" align='right' valign='middle' nowrap="nowrap"><div class='tableheadtext'>Voucher Type</div></td>
          <td>&nbsp;</td>
          <td valign='middle'>
            <div class='tabletext'>
    ...
    <div class="screenlet-body">
      ...
      <table width="100%" border='0' cellspacing='0' cellpadding='0' class='boxbottom'>
       <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td class="label" width="300" align='right' valign='middle' nowrap="nowrap"><div class='tableheadtext'>${uiLabelMap.OrderOrderEntryInternalOrganization}</div></td>
          <td>&nbsp;</td>
          <td valign='middle'>
            <div class='tabletext'>
        ...
        <tr>
          <td>&nbsp;</td>
          <td class="label" align='right' valign='middle' nowrap="nowrap"><div class='tableheadtext'>${uiLabelMap.PartySupplier} <span><font color="red">*</font></div></td>
          <td>&nbsp;</td>
          <td valign='middle'>
            <div class='tabletext'>
