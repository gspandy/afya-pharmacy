...
<div class="left" style="width:48%;">
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="0"  class="basic-table">
  
                <tr>
                  <td colspan="4">
                    <h1>Shipping Origin</h1>
                  </td>
                ...
                <#list shipToPartyShippingContactMechList as shippingContactMech>
                  ...
                  <td valign="top" nowrap="nowrap">
                      <input type="radio" name="shipping_origin_contact_mech_id" value="${shippingAddress.contactMechId}"/>
                    </td>
                    <td nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td valign="top" width="100%" nowrap="nowrap">
                      <div >
                        ...
                        <#if shippingAddress.address1?has_content><b>${shippingAddress.address1}</b><br/></#if>
                        <#if shippingAddress.address2?has_content><b>${shippingAddress.address2}</b><br/></#if>
                        <#if shippingAddress.city?has_content><b>${shippingAddress.city}</b></#if>
                        <#if shippingAddress.stateProvinceGeoId?has_content><b>${shippingAddress.stateProvinceGeoId}</b><br/></#if>
                        <#if shippingAddress.postalCode?has_content><b>${shippingAddress.postalCode}</b><br/></#if>
                        <#if shippingAddress.countryGeoId?has_content><b>${shippingAddress.countryGeoId}</b><br/></#if>
                      </div>
                    </td>
                    <td>&nbsp;</td>
                  </tr>
...
<#if facilityMaps?exists && cart.orderType=="PURCHASE_ORDER">
...
<#assign shipGroupIndex = currIndex - 1>
            <table width="100%" border="0" cellpadding="1" cellspacing="0"  class="basic-table">
                <tr>
                  <td colspan="4">
                 <!--   <h1>Shipping Destination${currIndex}</h1> -->
                ...
                <#list facilityContactMechList as shippingContactMech>
                  ...
                  <tr>
                    ...
                    <td>
                      <div><a href="/facility/control/EditContactMech?facilityId=${facility.facilityId}&amp;contactMechId=${shippingAddress.contactMechId}&amp;externalLoginKey=${externalLoginKey}" target="_blank" class="btn btn-success">${uiLabelMap.CommonUpdate}</a></div>
                    </td>
                  </tr>
                  <#if shippingContactMech_has_next>
                  <tr><td colspan="4"><hr /></td></tr>
                  ...
                  <tr>
                    <td colspan="4">
                      <div>
                        ...
                        <a href="/facility/control/EditContactMech?facilityId=${facility.facilityId}&amp;preContactMechTypeId=POSTAL_ADDRESS&amp;externalLoginKey=${externalLoginKey}" target="_blank" class="btn">${uiLabelMap.CommonNew}</a>
                      </div>
                    </td>
                </#if>
                </#list>
...
<#-- Sales Orders -->
            <form method="post" action="<@ofbizUrl>finalizeOrder</@ofbizUrl>" name="checkoutsetupform">
<div id="column-container">
            <#if facilityMaps?exists && cart.orderType=="SALES_ORDER">
<div class="left" style="width:48%">
            <input type="hidden" name="finalizeMode" value="ship"/>
            <table width="100%" border="0" cellpadding="1" cellspacing="0" class="basic-table">
                <tr>
                ...
                <#list facilityContactMechList as shippingContactMech>
                  ...
                  <tr>
                    <td valign="top" nowrap="nowrap">
                      <input type="radio" name="shipping_origin_contact_mech_id" value="${shippingAddress.contactMechId}" <#if cart.getShippingOriginContactMechId()?default("")==shippingAddress.contactMechId>checked</#if> />
                    </td>
                    <td nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td valign="top" width="100%" nowrap="nowrap">
                      <div>
...
<a href="<@ofbizUrl>setShipping?createNewShipGroup=Y</@ofbizUrl>" class="btn">${uiLabelMap.CommonCreateNew} ${uiLabelMap.OrderShipGroup}</a>
<a href="<@ofbizUrl>EditShipAddress</@ofbizUrl>" class="btn">${uiLabelMap.OrderCreateShippingAddress}</a>
