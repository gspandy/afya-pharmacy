  ...
  <#if searchOptionsHistoryList?has_content>
    ...
    <#-- searchOptions type is ProductSearchSession.ProductSearchOptions -->
        <div>
          ...
          <a href="<@ofbizUrl>setCurrentSearchFromHistoryAndSearch?searchHistoryIndex=${searchOptions_index}&amp;clearSearch=N</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonSearch}</a>
          <a href="<@ofbizUrl>setCurrentSearchFromHistory?searchHistoryIndex=${searchOptions_index}</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonRefine}</a>
        </div>
