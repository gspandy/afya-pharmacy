...
<table border="0" cellpadding="2" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td align="left" valign="top">
      ...
      <div>
        <b>
          ...
          <#else>
            ...
            ${uiLabelMap.ProductPerUnitPrice}: <#if "Y" = product.isVirtual?if_exists> ${uiLabelMap.CommonFrom} </#if>
      ...
      <form method="post" action="<@ofbizUrl>additem<#if requestAttributes._CURRENT_VIEW_?exists>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>" name="addform"
            id="addform" style="margin: 0;">
        <#assign inStock = true>
        <#-- Variant Selection -->
            ...
            <div id="add_amount" class="${hiddenStyle}">
              ...
              <#if product.productTypeId?if_exists == "ASSET_USAGE" || product.productTypeId?if_exists == "ASSET_USAGE_OUT_IN">
                <table width="100%" class="basic-table">
                    <tr>
                <td nowrap="nowrap" align="right"><b>Start Date</b></td>
                <td>
               <@htmlTemplate.renderDateTimeField name="reservStart" value="${nowTimestamp.toString().substring(0,19)!''}"
               className="date" alert="" title="Format: MM/dd/yyyy" size="15" maxlength="10" id="reservStart" dateType="date-time"
               ...
               pmSelected="" compositeType="" formName="addform"/>
                ...
                <td nowrap="nowrap" align="right"><b>End Date</b></td>
                <td>
                <@htmlTemplate.renderDateTimeField name="reservEnd" value="${nowTimestamp.toString().substring(0,19)!''}"
               className="date" alert="" title="Format: MM/dd/yyyy" size="15" maxlength="20" id="reservEnd" dateType="date-time"
               shortDateInput=false timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown=""
               timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected=""
               pmSelected="" compositeType="" formName="addform"/>
                </td>
                        ...
                        <td nowrap="nowrap" align="right">Number<br />of days</td>
                            <td>
                            <input type="textt" size="4" name="reservLength"/></td>
                            <tr>
                                <td>&nbsp;</td>
                        ...
                        <td class="left" >
                            <a href="javascript:addItem()" class="btn"><span style="white-space: nowrap;">${uiLabelMap.OrderAddToCart}</span></a>&nbsp;
                        </td>
                                </tr>
                </table>
              <#else>
  ...
  <#if assocProducts?has_content>
    <h4>${beforeName?if_exists}<#if showName == "Y">${productContentWrapper.get("PRODUCT_NAME")?if_exists}</#if>${afterName?if_exists}</h4>
