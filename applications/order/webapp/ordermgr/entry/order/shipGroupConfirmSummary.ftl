  ...
  <div class="screenlet-body">
    <table width="100%">
      ...
      <tr>
        ...
        <#if shipmentMethodTypeId?has_content>
      ...
      <tr>
        ...
        <td rowspan="${numberOfItems}" valign="top">
          <#assign supplier =  delegator.findByPrimaryKey("PartyGroup", Static["org.ofbiz.base.util.UtilMisc"].toMap("partyId", cart.getBillFromVendorPartyId()))?if_exists />      
