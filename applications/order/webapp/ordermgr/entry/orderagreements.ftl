  ...
  <div class="screenlet-body">
    <table>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align='right' valign='middle' class='tableheadtext' nowrap="nowrap">
          Customer ${uiLabelMap.OrderPONumber}
        </td>
        <td>&nbsp;</td>
        <td align='left'>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>
        <@htmlTemplate.renderDateTimeField name="shipAfterDate" value="${value!''}" className="" alert="" 
                ...
                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="agreementForm"/>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>
          <@htmlTemplate.renderDateTimeField name="shipBeforeDate" value="${value!''}" className="" alert="" 
                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="shipBeforeDate" dateType="date" shortDateInput=false 
                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="agreementForm"/>
        </td>
      </tr>
      ...
      <#if cart.getOrderType() == "PURCHASE_ORDER">
        <tr>
          ...
          <td>&nbsp;</td>
          <td>
            <@htmlTemplate.renderDateTimeField name="cancelBackOrderDate" value="${value!''}" className="" alert="" 
                title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="25" maxlength="30" id="cancelBackOrderDate" dateType="date" shortDateInput=false 
                timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" 
                hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName="agreementForm"/>
          </td>
        </tr>
