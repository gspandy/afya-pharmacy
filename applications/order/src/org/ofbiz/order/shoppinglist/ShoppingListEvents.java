      ...
      //    String accommodationSpotId = shoppingListItem.getString("accommodationSpotId");
            ...
            try {
                ...
                if (reservStart == null) {
                    ...
                    cart.addOrIncreaseItem(productId, null, quantity, reservStart,null, reservLength, reservPersons, null, null, null, null, null, attributes, prodCatalogId, configWrapper, null, null, null, dispatcher);
                }
