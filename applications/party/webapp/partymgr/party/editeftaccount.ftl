...
<div class="screenlet">
  ...
  <div class="screenlet-body">
        <div class="button-bar">
          <a href="<@ofbizUrl>${donePage}?partyId=${partyId}</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonCancelDone}</a>
          <a href="javascript:document.editeftaccountform.submit()" class="btn btn-primary">${uiLabelMap.CommonSave}</a>
        </div>
    <#if !eftAccount?exists>
    ...
    <#else>
      <form method="post" action='<@ofbizUrl>updateEftAccount?DONE_PAGE=${donePage}</@ofbizUrl>' name="editeftaccountform" style='margin: 0;'>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="<@ofbizUrl>editcontactmech</@ofbizUrl>" class="btn btn-primary">
      ...
      <div class="button-bar">
        <a href="<@ofbizUrl>backHome</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonCancelDone}</a>
        <a href="javascript:document.editeftaccountform.submit()" class="btn btn-primary">${uiLabelMap.CommonSave}</a>
      </div>
  </div>
</div>
