    ...
    <ul>
      ...
      <li>
        <form id="createEmptyShoppingList" action="<@ofbizUrl>createEmptyShoppingList</@ofbizUrl>" method="post">
          ...
          <a href="javascript:document.getElementById('createEmptyShoppingList').submit();" class="">${uiLabelMap.CommonCreateNew}</a>
        </form>
      </li>      
    </ul>
    <br class="clear"/>
      ...
      <table class="basic-table" cellspacing='0'>
        ...
        <tr>
          ...
          <td>
            ...
            <#if parentShoppingList?exists>
              <a href="<@ofbizUrl>editShoppingList?shoppingListId=${parentShoppingList.shoppingListId}</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonGotoParent} (${parentShoppingList.listName?default(parentShoppingList.shoppingListId)})</a>
            </#if>
          </td>
        </tr>
        <#if shoppingList.listName?default("") != "auto-save">
          <tr>
            <td>&nbsp;</td>
            <td><a href="javascript:document.updateList.submit();" class="btn btn-success">${uiLabelMap.CommonSave}</a></td>
          </tr>
        </#if>
      </table>
    </form>
...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    <form name="addToShoppingList" method="post" action="<@ofbizUrl>addItemToShoppingList<#if requestAttributes._CURRENT_VIEW_?exists>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
      ...
      <input type="submit" value="${uiLabelMap.PartyAddToShoppingList}" class="btn btn-success"/>
    </form>
  </div>
</div>
</#if>
