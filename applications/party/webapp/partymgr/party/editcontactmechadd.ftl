...
<#if mechMap.contactMechTypeId?has_content>
          ...
          <td>
            <table class="basic-table" cellspacing="0">
              ...
              <tr>
                ...
                <td><a href="javascript:document.newpurposeform.submit()" class="btn btn-primary">${uiLabelMap.PartyAddPurpose}</a></td>
              </tr>
            </table>
          </tr>
      </#if>
  ...
  <div class="button-bar">
    <a href="<@ofbizUrl>backHome</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonGoBack}</a>
    <a href="javascript:document.editcontactmechform.submit()" class="btn btn-primary">${uiLabelMap.CommonSave}</a>
  </div>
<#else>
  <a href="<@ofbizUrl>backHome</@ofbizUrl>" class="btn btn-primary">${uiLabelMap.CommonGoBack}</a>
</#if>
