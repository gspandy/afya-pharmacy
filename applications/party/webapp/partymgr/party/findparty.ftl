...
<#-- <div class="btn-mini"><a href="<@ofbizUrl>${createUrl}</@ofbizUrl>" class="buttontext"><i class="icon-plus"></i>${uiLabelMap.CommonCreateNew}</a></div> -->
<div class="screenlet">
      ...
      <form method="post" name="lookupparty" action="<@ofbizUrl>findparty</@ofbizUrl>" class="basic-form">
        ...
        <table class="basic-table" cellspacing="0">
          ...
          <tr>
            <td>&nbsp;</td>
            <td>
              <input type="submit" value="${uiLabelMap.CommonFind}" class="btn btn-primary" onclick="javascript:document.lookupparty.submit();"/>
            </td>
          </tr>
        </table>
      </form>
  ...
  <#if partyList?exists>
    ...
    <div id="findPartyResults" class="screenlet-title-bar">
      <ul>
        ...
        <#--    <td class="button-col">
              ...
              <#if security.hasRolePermission("ORDERMGR", "_VIEW", "", "", session)>
                  <form name= "searchorders_o_${rowCount}" method= "post" action= "/ordermgr/control/searchorders">
                    ...
                    <a href="javascript:document.searchorders_o_${rowCount}.submit()" class='buttontext'>${uiLabelMap.OrderOrders}</a>
                    
                </form>
                <a href="/ordermgr/control/FindQuote?partyId=${partyRow.partyId + externalKeyParam}" class='buttontext'>${uiLabelMap.OrderOrderQuotes}</a>
              </#if>
              <#if security.hasEntityPermission("ORDERMGR", "_CREATE", session)>
                <a href="/ordermgr/control/checkinits?partyId=${partyRow.partyId + externalKeyParam}" class='buttontext'>New Order</a>
                <a href="/ordermgr/control/EditQuote?partyId=${partyRow.partyId + externalKeyParam}" class='buttontext'>New Quote</a>
              </#if>
            </td> -->
          </tr>
