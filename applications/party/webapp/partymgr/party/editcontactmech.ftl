      ...
      <table class="basic-table" cellspacing="0">
        <tr>
          ...
          <td>
            ...
            <a href="javascript:document.createcontactmechform.submit()" class="btn btn-success">${uiLabelMap.CommonCreate}</a>
          </td>
        </tr>
      </table>
    </form>
...
<#if mechMap.contactMechTypeId?has_content>
          ...
          <td>
            <table class="basic-table" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td class="button-col">
                      <form name="deletePartyContactMechPurpose_${partyContactMechPurpose.contactMechPurposeTypeId}" method="post" action="<@ofbizUrl>deletePartyContactMechPurpose</@ofbizUrl>" >
                         ...
                         <input type="submit" class="btn btn-mini btn-danger" style="font-weight: bold;" value="${uiLabelMap.CommonDelete}"/>
                         <#-- <a href="javascript:document.deletePartyContactMechPurpose_${partyContactMechPurpose.contactMechPurposeTypeId}.submit()" class="btn btn-danger">${uiLabelMap.CommonDelete}</a> -->
                       </form>
                    </td>
                  </tr>
                </#list>
              ...
              <tr>
                ...
                <td><a href="javascript:document.newpurposeform.submit()" class="btn btn-mini btn-success">${uiLabelMap.PartyAddPurpose}</a></td>
              </tr>
            </table>
          </tr>
      </#if>
  ...
  <#if "POSTAL_ADDRESS" = mechMap.contactMechTypeId?if_exists>
    ...
    <tr>
      <td class="label">${uiLabelMap.PartyAddressLine1} <font color="red">*</font></td>
      <td>
    ...
    <tr>
      <td class="label">${uiLabelMap.PartyCity} <font color="red">*</font></td>
      <td>
    ...
    <tr>
      <td class="label">${uiLabelMap.CommonCountry} <font color="red">*</font></td>
      <td>
    ...
    <tr>
      <td class="label">${uiLabelMap.PartyState} <font color="red">*</font></td>
      <td>
    ...
    <tr>
      <td class="label">${uiLabelMap.PartyZipCode} <font color="red">*</font></td>
      <td>
  ...
  <div style="margin-left: 140px;">
    <a href="<@ofbizUrl>backHome</@ofbizUrl>" class="btn" style="font-weight: bold;">${uiLabelMap.CommonGoBack}</a>
    <a href="javascript:document.editcontactmechform.submit()" class="btn btn-success">${uiLabelMap.CommonSave}</a>
  </div>
<#else>
  <div style="margin-left: 140px;">
    <a href="<@ofbizUrl>backHome</@ofbizUrl>" class="btn" style="font-weight: bold;">${uiLabelMap.CommonGoBack}</a>
